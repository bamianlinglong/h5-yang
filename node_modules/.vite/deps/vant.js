...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/utils/validate.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/utils/basic.mjs
function noop() {
}
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/utils/props.mjs
...
// external:vue
var vue_exports = {};
__reExport(vue_exports, vue_star);
import * as vue_star from "vue";

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/@vant/use/dist/index.esm.mjs
...
var useRect = (elementOrRef) => {
  const element = (0, vue_exports.unref)(elementOrRef);
  if (isWindow(element)) {
...
function useToggle(defaultValue = false) {
  const state = (0, vue_exports.ref)(defaultValue);
...
function useParent(key) {
  const parent = (0, vue_exports.inject)(key, null);
  if (parent) {
    const instance4 = (0, vue_exports.getCurrentInstance)();
    const { link, unlink, internalChildren } = parent;
    link(instance4);
    (0, vue_exports.onUnmounted)(() => unlink(instance4));
    const index = (0, vue_exports.computed)(() => internalChildren.indexOf(instance4));
    return {
      parent,
      index
    };
  ...
  const traverse = (children2) => {
    if (Array.isArray(children2)) {
      children2.forEach((child) => {
        var _a;
        if ((0, vue_exports.isVNode)(child)) {
          result.push(child);
...
function useChildren(key) {
  const publicChildren = (0, vue_exports.reactive)([]);
  const internalChildren = (0, vue_exports.reactive)([]);
  const parent = (0, vue_exports.getCurrentInstance)();
...
function useCountDown(options) {
  ...
  let counting;
  let deactivated;
  const remain = (0, vue_exports.ref)(options.time);
  const current2 = (0, vue_exports.computed)(() => parseTime(remain.value));
  const pause = () => {
    counting = false;
    cancelRaf(rafId);
  };
  ...
  (0, vue_exports.onBeforeUnmount)(pause);
...
function useEventListener(type, listener, options = {}) {
  ...
  const add = (target2) => {
    ...
    const element = (0, vue_exports.unref)(target2);
    if (element && !attached) {
  ...
  (0, vue_exports.onUnmounted)(() => remove2(target));
  (0, vue_exports.onDeactivated)(() => remove2(target));
  onMountedOrActivated(() => add(target));
  let stopWatch;
  if ((0, vue_exports.isRef)(target)) {
    stopWatch = (0, vue_exports.watch)(target, (val, oldVal) => {
      remove2(oldVal);
      add(val);
    });
  }
...
function useClickAway(target, listener, options = {}) {
  ...
  const onClick = (event) => {
    ...
    const isClickAway = targets.every((item) => {
      const element = (0, vue_exports.unref)(item);
...
function useWindowSize() {
  if (!width) {
    width = (0, vue_exports.ref)(0);
    height = (0, vue_exports.ref)(0);
    if (inBrowser2) {
      const update = () => {
...
function useScrollParent(el, root = defaultRoot) {
  const scrollParent = (0, vue_exports.ref)();
  (0, vue_exports.onMounted)(() => {
    if (el.value) {
...
function usePageVisibility() {
  if (!visibility) {
    visibility = (0, vue_exports.ref)("visible");
    if (inBrowser2) {
      const update = () => {
...
function useCustomFieldValue(customValue) {
  const field = (0, vue_exports.inject)(CUSTOM_FIELD_INJECTION_KEY, null);
  if (field && !field.customValue.value) {
    field.customValue.value = customValue;
    (0, vue_exports.watch)(customValue, () => {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/utils/dom.mjs
...
function isHidden(elementRef) {
  const el = (0, vue_exports.unref)(elementRef);
  if (!el) {
    return false;
  }
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/utils/format.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/utils/deep-assign.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/locale/lang/zh-CN.mjs
var stdin_default = {
  name: "\u59D3\u540D",
  tel: "\u7535\u8BDD",
  save: "\u4FDD\u5B58",
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/locale/index.mjs
var lang = (0, vue_exports.ref)("zh-CN");
var messages = (0, vue_exports.reactive)({
  "zh-CN": stdin_default
});
var Locale = {
  messages() {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/utils/create.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/utils/constant.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/utils/interceptor.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/utils/with-install.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/on-popup-reopen.mjs
var POPUP_TOGGLE_KEY = Symbol();
function onPopupReopen(callback) {
  const popupToggleStatus = (0, vue_exports.inject)(POPUP_TOGGLE_KEY, null);
  if (popupToggleStatus) {
    (0, vue_exports.watch)(popupToggleStatus, (show) => {
      if (show) {
        callback();
      }
    });
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-height.mjs
var useHeight = (element, withSafeArea) => {
  const height2 = (0, vue_exports.ref)();
  const setHeight = () => {
    height2.value = useRect(element).height;
  };
  (0, vue_exports.onMounted)(() => {
    (0, vue_exports.nextTick)(setHeight);
    if (withSafeArea) {
      for (let i = 1; i <= 3; i++) {
  ...
  onPopupReopen(() => (0, vue_exports.nextTick)(setHeight));
  (0, vue_exports.watch)([windowWidth, windowHeight], setHeight);
  return height2;
};

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-placeholder.mjs
function usePlaceholder(contentRef, bem98) {
  const height2 = useHeight(contentRef, true);
  return (renderContent) => (0, vue_exports.createVNode)("div", {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/action-bar/ActionBar.mjs
...
var stdin_default3 = (0, vue_exports.defineComponent)({
  name,
  props: actionBarProps,
  setup(props, {
    slots
  }) {
    const root = (0, vue_exports.ref)();
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/action-bar/index.mjs
var ActionBar = withInstall(stdin_default3);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-expose.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-route.mjs
var routeProps = {
  to: [String, Object],
  url: String,
  replace: Boolean
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/badge/Badge.mjs
...
var stdin_default4 = (0, vue_exports.defineComponent)({
  name: name2,
  props: badgeProps,
  setup(props, {
    slots
    ...
    return () => {
      if (slots.default) {
        ...
        return (0, vue_exports.createVNode)(tag, {
          "class": bem2("wrapper")
        }, {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/badge/index.mjs
var Badge = withInstall(stdin_default4);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-global-z-index.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/config-provider/ConfigProvider.mjs
...
var stdin_default5 = (0, vue_exports.defineComponent)({
  name: name3,
  props: configProviderProps,
  setup(props, {
    slots
  }) {
    const style = (0, vue_exports.computed)(() => mapThemeVarsToCSSVars(extend({}, props.themeVars, props.theme === "dark" ? props.themeVarsDark : props.themeVarsLight)));
    if (inBrowser) {
      const addTheme = () => {
      ...
      (0, vue_exports.watch)(() => props.theme, (newVal, oldVal) => {
        if (oldVal) {
          removeTheme(oldVal);
        }
        addTheme();
      ...
      (0, vue_exports.onActivated)(addTheme);
      (0, vue_exports.onDeactivated)(removeTheme);
      (0, vue_exports.onBeforeUnmount)(removeTheme);
    }
    (0, vue_exports.provide)(CONFIG_PROVIDER_KEY, props);
    (0, vue_exports.watchEffect)(() => {
      if (props.zIndex !== void 0) {
        setGlobalZIndex(props.zIndex);
      }
    });
    return () => (0, vue_exports.createVNode)(props.tag, {
      "class": bem3(),
      "style": style.value
    }, {
      default: () => {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/icon/Icon.mjs
...
var stdin_default6 = (0, vue_exports.defineComponent)({
  name: name4,
  props: iconProps,
  setup(props, {
    slots
  }) {
    const config = (0, vue_exports.inject)(CONFIG_PROVIDER_KEY, null);
    const classPrefix = (0, vue_exports.computed)(() => props.classPrefix || (config == null ? void 0 : config.iconPrefix) || bem4());
    return () => {
      const {
        tag,
        dot,
      ...
      return (0, vue_exports.createVNode)(Badge, (0, vue_exports.mergeProps)({
        "dot": dot,
        "tag": tag,
        ...
        default: () => {
          var _a;
          return [(_a = slots.default) == null ? void 0 : _a.call(slots), isImageIcon && (0, vue_exports.createVNode)("img", {
            "class": bem4("image"),
            "src": name210
          }, null)];
        }
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/icon/index.mjs
var Icon = withInstall(stdin_default6);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/loading/Loading.mjs
var [name5, bem5] = createNamespace("loading");
var SpinIcon = Array(12).fill(null).map((_, index) => (0, vue_exports.createVNode)("i", {
  "class": bem5("line", String(index + 1))
}, null));
var CircularIcon = (0, vue_exports.createVNode)("svg", {
  "class": bem5("circular"),
  "viewBox": "25 25 50 50"
...
var stdin_default7 = (0, vue_exports.defineComponent)({
  name: name5,
  props: loadingProps,
  setup(props, {
    slots
  }) {
    const spinnerStyle = (0, vue_exports.computed)(() => extend({
      color: props.color
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/loading/index.mjs
var Loading = withInstall(stdin_default7);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/button/Button.mjs
...
var stdin_default8 = (0, vue_exports.defineComponent)({
  name: name6,
  props: buttonProps,
  emits: ["click"],
  setup(props, {
    ...
    const renderLoadingIcon = () => {
      ...
      return (0, vue_exports.createVNode)(Loading, {
    ...
    const renderIcon = () => {
      ...
      if (props.icon) {
        return (0, vue_exports.createVNode)(Icon, {
          "name": props.icon,
          "class": bem6("icon"),
    ...
    return () => {
      ...
      return (0, vue_exports.createVNode)(tag, {
        ...
        default: () => [(0, vue_exports.createVNode)("div", {
          "class": bem6("content")
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/button/index.mjs
var Button = withInstall(stdin_default8);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/action-bar-button/ActionBarButton.mjs
...
var stdin_default9 = (0, vue_exports.defineComponent)({
  name: name7,
  ...
  setup(props, {
    ...
    return () => {
      ...
      return (0, vue_exports.createVNode)(Button, {
        "class": bem7([type, {
          last: isLast.value,
          first: isFirst.value
        }]),
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/action-bar-button/index.mjs
var ActionBarButton = withInstall(stdin_default9);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/action-bar-icon/ActionBarIcon.mjs
...
var stdin_default10 = (0, vue_exports.defineComponent)({
  name: name8,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/action-bar-icon/index.mjs
var ActionBarIcon = withInstall(stdin_default10);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/popup/shared.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-touch.mjs
...
function useTouch() {
  const startX = (0, vue_exports.ref)(0);
  const startY = (0, vue_exports.ref)(0);
  const deltaX = (0, vue_exports.ref)(0);
  const deltaY = (0, vue_exports.ref)(0);
  const offsetX = (0, vue_exports.ref)(0);
  const offsetY = (0, vue_exports.ref)(0);
  const direction = (0, vue_exports.ref)("");
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-lock-scroll.mjs
...
function useLockScroll(rootRef, shouldLock) {
  ...
  (0, vue_exports.onDeactivated)(destroy);
  (0, vue_exports.onBeforeUnmount)(destroy);
  (0, vue_exports.watch)(shouldLock, (value) => {
    value ? lock() : unlock();
  });
}

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-lazy-render.mjs
function useLazyRender(show) {
  const inited = (0, vue_exports.ref)(false);
  (0, vue_exports.watch)(
    show,
    (value) => {
      if (value) {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/overlay/Overlay.mjs
...
var stdin_default11 = (0, vue_exports.defineComponent)({
  name: name9,
  props: overlayProps,
  setup(props, {
    slots
    ...
    const renderOverlay = lazyRender(() => {
      ...
      return (0, vue_exports.withDirectives)((0, vue_exports.createVNode)("div", {
        "ref": root,
        "style": style,
        "class": [bem9(), props.className]
      }, [(_a = slots.default) == null ? void 0 : _a.call(slots)]), [[vue_exports.vShow, props.show]]);
    });
    useEventListener("touchmove", onTouchMove, {
      target: root
    });
    return () => (0, vue_exports.createVNode)(vue_exports.Transition, {
      "name": "van-fade",
      "appear": true
    }, {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/overlay/index.mjs
var Overlay = withInstall(stdin_default11);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/popup/Popup.mjs
...
var stdin_default12 = (0, vue_exports.defineComponent)({
  name: name10,
  inheritAttrs: false,
  props: popupProps,
  ...
  setup(props, {
    ...
    let opened;
    let shouldReopen;
    const zIndex = (0, vue_exports.ref)();
    const popupRef = (0, vue_exports.ref)();
    const lazyRender = useLazyRender(() => props.show || !props.lazyRender);
    const style = (0, vue_exports.computed)(() => {
      const style2 = {
        zIndex: zIndex.value
    ...
    const renderOverlay = () => {
      if (props.overlay) {
        return (0, vue_exports.createVNode)(Overlay, {
          "show": props.show,
    ...
    const renderPopup = lazyRender(() => {
      ...
      return (0, vue_exports.withDirectives)((0, vue_exports.createVNode)("div", (0, vue_exports.mergeProps)({
        "ref": popupRef,
        "style": style.value,
        "role": "dialog",
        "tabindex": 0,
        ...
        "onKeydown": onKeydown
      }, attrs), [(_a = slots.default) == null ? void 0 : _a.call(slots), renderCloseIcon()]), [[vue_exports.vShow, props.show]]);
    });
    ...
    (0, vue_exports.watch)(() => props.show, (show) => {
      if (show && !opened) {
        open();
        if (attrs.tabindex === 0) {
          (0, vue_exports.nextTick)(() => {
    ...
    (0, vue_exports.provide)(POPUP_TOGGLE_KEY, () => props.show);
    return () => {
      if (props.teleport) {
        return (0, vue_exports.createVNode)(vue_exports.Teleport, {
          "to": props.teleport
        }, {
          default: () => [renderOverlay(), renderTransition()]
        });
      }
      return (0, vue_exports.createVNode)(vue_exports.Fragment, null, [renderOverlay(), renderTransition()]);
    };
  }
});

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/popup/index.mjs
var Popup = withInstall(stdin_default12);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/action-sheet/ActionSheet.mjs
...
var stdin_default13 = (0, vue_exports.defineComponent)({
  name: name11,
  ...
  setup(props, {
    ...
    const renderHeader = () => {
      if (props.title) {
        return (0, vue_exports.createVNode)("div", {
          "class": bem11("header")
        }, [props.title, props.closeable && (0, vue_exports.createVNode)(Icon, {
          "name": props.closeIcon,
    ...
    const renderCancel = () => {
      if (slots.cancel || props.cancelText) {
        return [(0, vue_exports.createVNode)("div", {
          "class": bem11("gap")
        }, null), (0, vue_exports.createVNode)("button", {
          "type": "button",
          "class": bem11("cancel"),
          "onClick": onCancel
    ...
    const renderActionContent = (action, index) => {
      ...
      return [(0, vue_exports.createVNode)("span", {
        "class": bem11("name")
      }, [action.name]), action.subname && (0, vue_exports.createVNode)("div", {
        "class": bem11("subname")
      }, [action.subname])];
    };
    const renderAction = (action, index) => {
      ...
      const onClick = () => {
        ...
        (0, vue_exports.nextTick)(() => emit("select", action, index));
      };
      return (0, vue_exports.createVNode)("button", {
        "type": "button",
        "style": {
    ...
    return () => (0, vue_exports.createVNode)(Popup, (0, vue_exports.mergeProps)({
      "class": bem11(),
      "position": "bottom",
      ...
      default: () => {
        var _a;
        return [renderHeader(), renderDescription(), (0, vue_exports.createVNode)("div", {
          "class": bem11("content")
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/action-sheet/index.mjs
var ActionSheet = withInstall(stdin_default13);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/picker/utils.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/picker/PickerColumn.mjs
...
var stdin_default14 = (0, vue_exports.defineComponent)({
  name: name13,
  props: {
    value: numericProp,
  ...
  setup(props, {
    ...
    const currentOffset = (0, vue_exports.ref)(0);
    const currentDuration = (0, vue_exports.ref)(0);
    const touch = useTouch();
    ...
    const renderOptions = () => {
      ...
      return props.options.map((option, index) => {
        ...
        return (0, vue_exports.createVNode)("li", data, [slots.option ? slots.option(option, index) : (0, vue_exports.createVNode)("div", childData, null)]);
      });
    };
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/picker/PickerToolbar.mjs
...
var stdin_default15 = (0, vue_exports.defineComponent)({
  name: name14,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tabs/utils.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-id.mjs
var current = 0;
function useId() {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-refs.mjs
function useRefs() {
  const refs = (0, vue_exports.ref)([]);
  const cache = [];
  (0, vue_exports.onBeforeUpdate)(() => {
    refs.value = [];
  });
  const setRefs = (index) => {
    if (!cache[index]) {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-visibility-change.mjs
function useVisibilityChange(target, onChange) {
  ...
  (0, vue_exports.onDeactivated)(unobserve);
  (0, vue_exports.onBeforeUnmount)(unobserve);
  onMountedOrActivated(observe);
}

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/sticky/Sticky.mjs
...
var stdin_default16 = (0, vue_exports.defineComponent)({
  name: name15,
  props: stickyProps,
  emits: ["scroll", "change"],
  setup(props, {
    ...
    const offset2 = (0, vue_exports.computed)(() => unitToPx(props.position === "top" ? props.offsetTop : props.offsetBottom));
    ...
    const stickyStyle = (0, vue_exports.computed)(() => {
      if (!state.fixed) {
        return;
      }
    ...
    (0, vue_exports.watch)(() => state.fixed, (value) => emit("change", value));
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/sticky/index.mjs
var Sticky = withInstall(stdin_default16);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tabs/TabsTitle.mjs
var [name16, bem15] = createNamespace("tab");
var stdin_default17 = (0, vue_exports.defineComponent)({
  name: name16,
  props: {
    id: String,
    dot: Boolean,
  ...
  setup(props, {
    ...
    const renderText = () => {
      const Text2 = (0, vue_exports.createVNode)("span", {
        "class": bem15("text", {
          ellipsis: !props.scrollable
        })
      }, [slots.title ? slots.title() : props.title]);
      if (props.dot || isDef(props.badge) && props.badge !== "") {
        return (0, vue_exports.createVNode)(Badge, {
          "dot": props.dot,
          "content": props.badge,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/swipe/Swipe.mjs
...
var stdin_default18 = (0, vue_exports.defineComponent)({
  name: name17,
  props: swipeProps,
  ...
  setup(props, {
    ...
    const count = (0, vue_exports.computed)(() => children.length);
    const size = (0, vue_exports.computed)(() => state[props.vertical ? "height" : "width"]);
    const delta = (0, vue_exports.computed)(() => props.vertical ? touch.deltaY.value : touch.deltaX.value);
    const minOffset = (0, vue_exports.computed)(() => {
      if (state.rect) {
    ...
    const maxCount = (0, vue_exports.computed)(() => size.value ? Math.ceil(Math.abs(minOffset.value) / size.value) : count.value);
    const trackSize = (0, vue_exports.computed)(() => count.value * size.value);
    const activeIndicator = (0, vue_exports.computed)(() => (state.active + count.value) % count.value);
    const isCorrectDirection = (0, vue_exports.computed)(() => {
    ...
    const initialize = (active = +props.initialSwipe) => {
      ...
      if (isHidden(root)) {
        (0, vue_exports.nextTick)().then(cb);
      } else {
        cb();
      }
    };
    ...
    const renderDot = (_, index) => {
      ...
      return (0, vue_exports.createVNode)("i", {
        "style": style,
    ...
    (0, vue_exports.watch)(() => props.initialSwipe, (value) => initialize(+value));
    (0, vue_exports.watch)(count, () => initialize(state.active));
    (0, vue_exports.watch)(() => props.autoplay, autoplay);
    (0, vue_exports.watch)([windowWidth, windowHeight], resize);
    (0, vue_exports.watch)(usePageVisibility(), (visible) => {
      if (visible === "visible") {
        autoplay();
      } else {
        stopAutoplay();
    ...
    (0, vue_exports.onMounted)(initialize);
    (0, vue_exports.onActivated)(() => initialize(state.active));
    onPopupReopen(() => initialize(state.active));
    (0, vue_exports.onDeactivated)(stopAutoplay);
    (0, vue_exports.onBeforeUnmount)(stopAutoplay);
    useEventListener("touchmove", onTouchMove, {
      target: track
    });
    return () => {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/swipe/index.mjs
var Swipe = withInstall(stdin_default18);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tabs/TabsContent.mjs
var [name18, bem17] = createNamespace("tabs");
var stdin_default19 = (0, vue_exports.defineComponent)({
  name: name18,
  props: {
  ...
  setup(props, {
    ...
    const swipeRef = (0, vue_exports.ref)();
    const onChange = (index) => emit("change", index);
    const renderChildren = () => {
      var _a;
      const Content = (_a = slots.default) == null ? void 0 : _a.call(slots);
      if (props.animated || props.swipeable) {
        return (0, vue_exports.createVNode)(Swipe, {
          "ref": swipeRef,
          "loop": false,
          "class": bem17("track"),
    ...
    (0, vue_exports.watch)(() => props.currentIndex, swipeToCurrentTab);
    (0, vue_exports.onMounted)(() => {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tabs/Tabs.mjs
...
var stdin_default20 = (0, vue_exports.defineComponent)({
  name: name19,
  props: tabsProps,
  ...
  setup(props, {
    ...
    let stickyFixed;
    const root = (0, vue_exports.ref)();
    const navRef = (0, vue_exports.ref)();
    ...
    const scrollable = (0, vue_exports.computed)(() => children.length > props.swipeThreshold || !props.ellipsis || props.shrink);
    ...
    const currentName = (0, vue_exports.computed)(() => {
      const activeTab = children[state.currentIndex];
      if (activeTab) {
        return getTabName(activeTab, state.currentIndex);
      }
    });
    const offsetTopPx = (0, vue_exports.computed)(() => unitToPx(props.offsetTop));
    const scrollOffset = (0, vue_exports.computed)(() => {
      if (props.sticky) {
    ...
    const renderNav = () => children.map((item, index) => (0, vue_exports.createVNode)(stdin_default17, (0, vue_exports.mergeProps)({
      "key": item.id,
      "id": `${id}-${index}`,
    ...
    (0, vue_exports.watch)([() => props.color, windowWidth], setLine);
    (0, vue_exports.watch)(() => props.active, (value) => {
      if (value !== currentName.value) {
        setCurrentIndexByName(value);
      }
    });
    (0, vue_exports.watch)(() => children.length, () => {
      if (state.inited) {
    ...
    (0, vue_exports.onActivated)(setLine);
    ...
    }, [props.sticky ? (0, vue_exports.createVNode)(Sticky, {
      "container": root.value,
      "offsetTop": offsetTopPx.value,
      "onScroll": onStickyScroll
    }, {
      default: () => [renderHeader()]
    }) : renderHeader(), (0, vue_exports.createVNode)(stdin_default19, {
      "ref": contentRef,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-tab-status.mjs
var TAB_STATUS_KEY = Symbol();
var useTabStatus = () => (0, vue_exports.inject)(TAB_STATUS_KEY, null);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/swipe-item/SwipeItem.mjs
var [name20, bem19] = createNamespace("swipe-item");
var stdin_default21 = (0, vue_exports.defineComponent)({
  name: name20,
  setup(props, {
    slots
  }) {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/swipe-item/index.mjs
var SwipeItem = withInstall(stdin_default21);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tab/Tab.mjs
...
var stdin_default22 = (0, vue_exports.defineComponent)({
  name: name21,
  props: tabProps,
  setup(props, {
    slots
    ...
    const hasInactiveClass = (0, vue_exports.ref)(!active.value);
    ...
    (0, vue_exports.watch)(() => props.title, () => {
      parent.setLine();
      parent.scrollIntoView();
    });
    (0, vue_exports.provide)(TAB_STATUS_KEY, active);
    return () => {
      var _a;
      ...
      if (animated || swipeable) {
        return (0, vue_exports.createVNode)(SwipeItem, {
          "id": id,
          "role": "tabpanel",
      ...
      return (0, vue_exports.withDirectives)((0, vue_exports.createVNode)("div", {
        ...
        "tabindex": show ? 0 : -1,
        "aria-labelledby": label
      }, [Content]), [[vue_exports.vShow, show]]);
    };
  }
});

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tab/index.mjs
var Tab = withInstall(stdin_default22);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tabs/index.mjs
var Tabs = withInstall(stdin_default20);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/picker-group/PickerGroup.mjs
...
var stdin_default23 = (0, vue_exports.defineComponent)({
  name: name22,
  ...
  setup(props, {
    ...
    const activeTab = (0, vue_exports.ref)(0);
    const {
      children,
      linkChildren
    ...
    return () => {
      ...
      return (0, vue_exports.createVNode)("div", {
        "class": bem21()
      }, [(0, vue_exports.createVNode)(stdin_default15, {
        "title": props.title,
        "cancelButtonText": props.cancelButtonText,
        "confirmButtonText": confirmButtonText,
        "onConfirm": onConfirm,
        "onCancel": onCancel
      }, pick(slots, pickerToolbarSlots)), (0, vue_exports.createVNode)(Tabs, {
        ...
        default: () => [props.tabs.map((title, index) => (0, vue_exports.createVNode)(Tab, {
          "title": title,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/picker/Picker.mjs
...
var stdin_default24 = (0, vue_exports.defineComponent)({
  name: name12,
  props: pickerProps,
  ...
  setup(props, {
    ...
    const columnsRef = (0, vue_exports.ref)();
    const selectedValues = (0, vue_exports.ref)(props.modelValue.slice(0));
    const {
      parent
    ...
    linkChildren();
    const fields = (0, vue_exports.computed)(() => assignDefaultFields(props.columnsFieldNames));
    const optionHeight = (0, vue_exports.computed)(() => unitToPx(props.optionHeight));
    const columnsType = (0, vue_exports.computed)(() => getColumnsType(props.columns, fields.value));
    const currentColumns = (0, vue_exports.computed)(() => {
      const {
        columns
      } = props;
    ...
    const hasOptions = (0, vue_exports.computed)(() => currentColumns.value.some((options) => options.length));
    const selectedOptions = (0, vue_exports.computed)(() => currentColumns.value.map((options, index) => findOptionByValue(options, selectedValues.value[index], fields.value)));
    const selectedIndexes = (0, vue_exports.computed)(() => currentColumns.value.map((options, index) => options.findIndex((option) => option[fields.value.value] === selectedValues.value[index])));
    ...
    const renderColumnItems = () => currentColumns.value.map((options, columnIndex) => (0, vue_exports.createVNode)(stdin_default14, {
    ...
    const renderMask = (wrapHeight) => {
      if (hasOptions.value) {
        ...
        return [(0, vue_exports.createVNode)("div", {
          "class": bem12("mask"),
          "style": maskStyle
        }, null), (0, vue_exports.createVNode)("div", {
    ...
    const renderToolbar = () => {
      if (props.showToolbar && !parent) {
        return (0, vue_exports.createVNode)(stdin_default15, (0, vue_exports.mergeProps)(pick(props, pickerToolbarPropKeys), {
          "onConfirm": confirm,
          "onCancel": cancel
        }), pick(slots, pickerToolbarSlots));
      }
    };
    (0, vue_exports.watch)(currentColumns, (columns) => {
    ...
    (0, vue_exports.watch)(() => props.modelValue, (newValues) => {
    ...
    (0, vue_exports.watch)(selectedValues, (newValues) => {
    ...
    return () => {
      ...
      return (0, vue_exports.createVNode)("div", {
        "class": bem12()
      }, [props.toolbarPosition === "top" ? renderToolbar() : null, props.loading ? (0, vue_exports.createVNode)(Loading, {
        "class": bem12("loading")
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/area/utils.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/picker/index.mjs
var Picker = withInstall(stdin_default24);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/area/Area.mjs
...
var stdin_default25 = (0, vue_exports.defineComponent)({
  name: name23,
  props: areaProps,
  ...
  setup(props, {
    ...
    const codes = (0, vue_exports.ref)([]);
    const picker = (0, vue_exports.ref)();
    const columns = (0, vue_exports.computed)(() => formatDataForCascade(props));
    const onChange = (...args) => emit("change", ...args);
    const onCancel = (...args) => emit("cancel", ...args);
    const onConfirm = (...args) => emit("confirm", ...args);
    (0, vue_exports.watch)(codes, (newCodes) => {
    ...
    (0, vue_exports.watch)(() => props.modelValue, (newCode) => {
      if (newCode) {
    ...
    return () => (0, vue_exports.createVNode)(Picker, (0, vue_exports.mergeProps)({
      "ref": picker,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/area/index.mjs
var Area = withInstall(stdin_default25);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/cell/Cell.mjs
...
var stdin_default26 = (0, vue_exports.defineComponent)({
  name: name24,
  props: cellProps,
  setup(props, {
    slots
    ...
    const renderTitle = () => {
      ...
      if (slots.title || isDef(props.title)) {
        ...
        }, [titleSlot || (0, vue_exports.createVNode)("span", null, [props.title]), renderLabel()]);
      }
    };
    const renderValue = () => {
      ...
      if (hasValue) {
        ...
        }, [slot ? slot() : (0, vue_exports.createVNode)("span", null, [props.value])]);
      }
    };
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/cell/index.mjs
var Cell = withInstall(stdin_default26);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/form/Form.mjs
...
var stdin_default27 = (0, vue_exports.defineComponent)({
  name: name25,
  props: formProps,
  emits: ["submit", "failed"],
  setup(props, {
    ...
    return () => {
      var _a;
      return (0, vue_exports.createVNode)("form", {
        "class": bem24(),
        "onSubmit": onSubmit
      }, [(_a = slots.default) == null ? void 0 : _a.call(slots)]);
    };
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/form/index.mjs
var Form = withInstall(stdin_default27);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/field/utils.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/field/Field.mjs
...
var stdin_default28 = (0, vue_exports.defineComponent)({
  name: name26,
  props: fieldProps,
  ...
  setup(props, {
    ...
    const clearIconRef = (0, vue_exports.ref)();
    const customValue = (0, vue_exports.ref)();
    const {
      parent: form
    } = useParent(FORM_KEY);
    const getModelValue = () => {
    ...
    const showClear = (0, vue_exports.computed)(() => {
    ...
    const formValue = (0, vue_exports.computed)(() => {
    ...
    const onFocus = (event) => {
      state.focused = true;
      emit("focus", event);
      (0, vue_exports.nextTick)(adjustTextareaSize);
      if (getProp("readonly")) {
        blur();
      }
    };
    ...
    const showError = (0, vue_exports.computed)(() => {
    ...
    const renderInput = () => {
      ...
      if (props.type === "textarea") {
        return (0, vue_exports.createVNode)("textarea", inputAttrs, null);
      }
      return (0, vue_exports.createVNode)("input", (0, vue_exports.mergeProps)(mapInputType(props.type), inputAttrs), null);
    };
    const renderLeftIcon = () => {
      ...
      if (props.leftIcon || leftIconSlot) {
        ...
        }, [leftIconSlot ? leftIconSlot() : (0, vue_exports.createVNode)(Icon, {
          "name": props.leftIcon,
          "classPrefix": props.iconPrefix
        }, null)]);
      }
    ...
    const renderRightIcon = () => {
      ...
      if (props.rightIcon || rightIconSlot) {
        ...
        }, [rightIconSlot ? rightIconSlot() : (0, vue_exports.createVNode)(Icon, {
    ...
    const renderWordLimit = () => {
      if (props.showWordLimit && props.maxlength) {
        ...
        }, [count]), (0, vue_exports.createTextVNode)("/"), props.maxlength]);
      }
    };
    const renderMessage = () => {
    ...
    const renderLabel = () => {
      ...
      if (props.label) {
        return (0, vue_exports.createVNode)("label", {
          "id": `${id}-label`,
          "for": getInputId()
        }, [props.label + colon]);
      }
    };
    const renderFieldBody = () => [(0, vue_exports.createVNode)("div", {
      "class": bem25("body")
    }, [renderInput(), showClear.value && (0, vue_exports.createVNode)(Icon, {
      "ref": clearIconRef,
      "name": props.clearIcon,
      "class": bem25("clear")
    }, null), renderRightIcon(), slots.button && (0, vue_exports.createVNode)("div", {
      "class": bem25("button")
    ...
    (0, vue_exports.provide)(CUSTOM_FIELD_INJECTION_KEY, {
      customValue,
      resetValidation,
      validateWithTrigger
    });
    ...
    return () => {
      ...
      return (0, vue_exports.createVNode)(Cell, {
        "size": props.size,
        "class": bem25({
          error: showError.value,
          disabled,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/field/index.mjs
var Field = withInstall(stdin_default28);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/toast/lock-click.mjs
var lockCount = 0;
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/toast/Toast.mjs
...
var stdin_default29 = (0, vue_exports.defineComponent)({
  name: name27,
  props: toastProps,
  emits: ["update:show"],
  setup(props, {
    ...
    const renderMessage = () => {
      ...
      if (isDef(message) && message !== "") {
        return type === "html" ? (0, vue_exports.createVNode)("div", {
          "key": 0,
          "class": bem26("text"),
    ...
    (0, vue_exports.watch)(() => [props.show, props.forbidClick], toggleClickable);
    (0, vue_exports.watch)(() => [props.show, props.type, props.message, props.duration], () => {
      clearTimer();
    ...
    (0, vue_exports.onMounted)(toggleClickable);
    (0, vue_exports.onUnmounted)(toggleClickable);
    return () => (0, vue_exports.createVNode)(Popup, (0, vue_exports.mergeProps)({
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/utils/mount-component.mjs
...
function mountComponent(RootComponent) {
  const app = (0, vue_exports.createApp)(RootComponent);
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/toast/function-call.mjs
var defaultOptions = {
  icon: "",
  type: "text",
  message: "",
  ...
  const {
    ...
    setup() {
      ...
      const render = () => {
        ...
        return (0, vue_exports.createVNode)(stdin_default29, (0, vue_exports.mergeProps)(state, attrs), null);
      };
      (0, vue_exports.watch)(message, (val) => {
        state.message = val;
      });
      (0, vue_exports.getCurrentInstance)().render = render;
      return {
        open,
        close,
        message
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/toast/index.mjs
var Toast = withInstall(stdin_default29);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/switch/Switch.mjs
...
var stdin_default30 = (0, vue_exports.defineComponent)({
  name: name28,
  props: switchProps,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/switch/index.mjs
var Switch = withInstall(stdin_default30);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/address-edit/AddressEditDetail.mjs
var [name29, bem28] = createNamespace("address-edit-detail");
var t2 = createNamespace("address-edit")[2];
var stdin_default31 = (0, vue_exports.defineComponent)({
  name: name29,
  props: {
    show: Boolean,
    rows: numericProp,
  ...
  setup(props, {
    ...
    const renderSearchResult = () => {
      ...
      return searchResult.map((express) => (0, vue_exports.createVNode)(Cell, {
        "clickable": true,
    ...
    return () => {
      if (props.show) {
        return (0, vue_exports.createVNode)(vue_exports.Fragment, null, [(0, vue_exports.createVNode)(Field, {
          "autosize": true,
          "clearable": true,
          "ref": field,
          "class": bem28(),
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/address-edit/AddressEdit.mjs
...
var stdin_default32 = (0, vue_exports.defineComponent)({
  name: name30,
  ...
  setup(props, {
    ...
    const areaRef = (0, vue_exports.ref)();
    const data = (0, vue_exports.reactive)({});
    const showAreaPopup = (0, vue_exports.ref)(false);
    const detailFocused = (0, vue_exports.ref)(false);
    const areaListLoaded = (0, vue_exports.computed)(() => isObject(props.areaList) && Object.keys(props.areaList).length);
    const areaText = (0, vue_exports.computed)(() => {
      const {
        province,
        city,
        county,
    ...
    const hideBottomFields = (0, vue_exports.computed)(() => {
      var _a;
    ...
    const renderSetDefaultCell = () => {
      if (props.showSetDefault) {
        const slots2 = {
          "right-icon": () => (0, vue_exports.createVNode)(Switch, {
            "modelValue": data.isDefault,
            "onUpdate:modelValue": ($event) => data.isDefault = $event,
            "onChange": (event) => emit("changeDefault", event)
          }, null)
        };
        return (0, vue_exports.withDirectives)((0, vue_exports.createVNode)(Cell, {
          "center": true,
          "title": t3("defaultAddress"),
          "class": bem29("default")
        }, slots2), [[vue_exports.vShow, !hideBottomFields.value]]);
      }
    };
    useExpose({
      setAreaCode,
    ...
    (0, vue_exports.watch)(() => props.addressInfo, (value) => {
    ...
    return () => {
      ...
      return (0, vue_exports.createVNode)(Form, {
        ...
        default: () => {
          ...
          return [(0, vue_exports.createVNode)("div", {
            "class": bem29("fields")
          }, [(0, vue_exports.createVNode)(Field, {
          ...
          }, null), (0, vue_exports.createVNode)(Field, {
            "modelValue": data.tel,
            ...
            "placeholder": t3("tel"),
            "onFocus": () => onFocus("tel")
          }, null), (0, vue_exports.withDirectives)((0, vue_exports.createVNode)(Field, {
            "readonly": true,
            "label": t3("area"),
            "is-link": !disableArea,
          ...
          }, null), [[vue_exports.vShow, props.showArea]]), (0, vue_exports.createVNode)(stdin_default31, {
          ...
          }, null), (_a = slots.default) == null ? void 0 : _a.call(slots)]), renderSetDefaultCell(), (0, vue_exports.withDirectives)((0, vue_exports.createVNode)("div", {
            "class": bem29("buttons")
            ...
            "nativeType": "submit"
          }, null), props.showDelete && (0, vue_exports.createVNode)(Button, {
            "block": true,
            "round": true,
            "class": bem29("button"),
            ...
            "onClick": onDelete
          }, null)]), [[vue_exports.vShow, !hideBottomFields.value]]), (0, vue_exports.createVNode)(Popup, {
            ...
            default: () => [(0, vue_exports.createVNode)(Area, {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/address-edit/index.mjs
var AddressEdit = withInstall(stdin_default32);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/radio-group/RadioGroup.mjs
...
var stdin_default33 = (0, vue_exports.defineComponent)({
  name: name31,
  ...
  setup(props, {
    ...
    (0, vue_exports.watch)(() => props.modelValue, (value) => emit("change", value));
    linkChildren({
      props,
      updateValue
    });
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/radio-group/index.mjs
var RadioGroup = withInstall(stdin_default33);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tag/Tag.mjs
...
var stdin_default34 = (0, vue_exports.defineComponent)({
  name: name32,
  props: tagProps,
  emits: ["close"],
  setup(props, {
    ...
    const renderTag = () => {
      ...
      const CloseIcon = closeable && (0, vue_exports.createVNode)(Icon, {
        "name": "cross",
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tag/index.mjs
var Tag = withInstall(stdin_default34);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/checkbox/Checker.mjs
var checkerProps = {
  name: unknownProp,
...
var stdin_default35 = (0, vue_exports.defineComponent)({
  ...
  setup(props, {
    ...
    const iconRef = (0, vue_exports.ref)();
    const getParentProp = (name103) => {
      if (props.parent && props.bindGroup) {
        return props.parent.props[name103];
      }
    };
    const disabled = (0, vue_exports.computed)(() => getParentProp("disabled") || props.disabled);
    const direction = (0, vue_exports.computed)(() => getParentProp("direction"));
    const iconStyle = (0, vue_exports.computed)(() => {
    ...
    const renderIcon = () => {
      ...
      return (0, vue_exports.createVNode)("div", {
        ...
        checked,
        disabled: disabled.value
      }) : (0, vue_exports.createVNode)(Icon, {
        "name": "success",
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/radio/Radio.mjs
var radioProps = checkerProps;
var [name33, bem32] = createNamespace("radio");
var stdin_default36 = (0, vue_exports.defineComponent)({
  name: name33,
  props: checkerProps,
  ...
  setup(props, {
    ...
    return () => (0, vue_exports.createVNode)(stdin_default35, (0, vue_exports.mergeProps)({
      "bem": bem32,
      "role": "radio",
      "parent": parent,
      "checked": checked(),
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/radio/index.mjs
var Radio = withInstall(stdin_default36);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/address-list/AddressListItem.mjs
var [name34, bem33] = createNamespace("address-item");
var stdin_default37 = (0, vue_exports.defineComponent)({
  name: name34,
  props: {
  ...
  setup(props, {
    ...
    const renderRightIcon = () => (0, vue_exports.createVNode)(Icon, {
      "name": "edit",
      "class": bem33("edit"),
      "onClick": (event) => {
        event.stopPropagation();
    ...
    const renderContent = () => {
      ...
      const Info = [(0, vue_exports.createVNode)("div", {
        "class": bem33("name")
      }, [`${address.name} ${address.tel}`, renderTag()]), (0, vue_exports.createVNode)("div", {
        "class": bem33("address")
      }, [address.address])];
      if (switchable && !disabled) {
        return (0, vue_exports.createVNode)(Radio, {
          "name": address.id,
          "iconSize": 18
        }, {
          default: () => [Info]
    ...
    return () => {
      ...
      return (0, vue_exports.createVNode)("div", {
        ...
        "onClick": onClick
      }, [(0, vue_exports.createVNode)(Cell, {
        "border": false,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/address-list/AddressList.mjs
...
var stdin_default38 = (0, vue_exports.defineComponent)({
  name: name35,
  ...
  setup(props, {
    ...
    const renderItem = (item, index, disabled) => {
      ...
      return (0, vue_exports.createVNode)(stdin_default37, {
        "key": item.id,
        "address": item,
        "disabled": disabled,
    ...
    const renderBottom = () => (0, vue_exports.createVNode)("div", {
    ...
    return () => {
      ...
      const DisabledText = props.disabledText && (0, vue_exports.createVNode)("div", {
        "class": bem34("disabled-text")
      }, [props.disabledText]);
      return (0, vue_exports.createVNode)("div", {
        "class": bem34()
      }, [(_a = slots.top) == null ? void 0 : _a.call(slots), (0, vue_exports.createVNode)(RadioGroup, {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/address-list/index.mjs
var AddressList = withInstall(stdin_default38);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/lazyload/vue-lazyload/util.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/back-top/BackTop.mjs
...
var stdin_default39 = (0, vue_exports.defineComponent)({
  name: name36,
  inheritAttrs: false,
  props: backTopProps,
  emits: ["click"],
  setup(props, {
    ...
    const root = (0, vue_exports.ref)();
    const scrollParent = (0, vue_exports.ref)();
    const style = (0, vue_exports.computed)(() => extend(getZIndexStyle(props.zIndex), {
    ...
    (0, vue_exports.onMounted)(updateTarget);
    (0, vue_exports.watch)(() => props.target, updateTarget);
    return () => {
      const Content = (0, vue_exports.createVNode)("div", (0, vue_exports.mergeProps)({
        "ref": root,
        "class": bem35({
          active: show.value
        }),
        "style": style.value,
        "onClick": onClick
      }, attrs), [slots.default ? slots.default() : (0, vue_exports.createVNode)(Icon, {
        "name": "back-top",
        "class": bem35("icon")
      }, null)]);
      if (props.teleport) {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/back-top/index.mjs
var BackTop = withInstall(stdin_default39);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/calendar/utils.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/date-picker/utils.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/calendar/CalendarDay.mjs
var [name38] = createNamespace("calendar-day");
var stdin_default40 = (0, vue_exports.defineComponent)({
  name: name38,
  props: {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/calendar/CalendarMonth.mjs
...
var stdin_default41 = (0, vue_exports.defineComponent)({
  name: name39,
  ...
  setup(props, {
    ...
    const daysRef = (0, vue_exports.ref)();
    const monthRef = (0, vue_exports.ref)();
    const height2 = useHeight(monthRef);
    const title = (0, vue_exports.computed)(() => formatMonthTitle(props.date));
    const rowHeight = (0, vue_exports.computed)(() => addUnit(props.rowHeight));
    const offset2 = (0, vue_exports.computed)(() => {
    ...
    const totalDay = (0, vue_exports.computed)(() => getMonthEndDay(props.date.getFullYear(), props.date.getMonth() + 1));
    const shouldRender = (0, vue_exports.computed)(() => visible.value || !props.lazyRender);
    ...
    const placeholders = (0, vue_exports.computed)(() => {
    ...
    const disabledDays = (0, vue_exports.computed)(() => days.value.filter((day) => day.type === "disabled"));
    ...
    const renderDay = (item, index) => (0, vue_exports.createVNode)(stdin_default40, {
      "item": item,
      "index": index,
      "color": props.color,
    ...
    const renderDays = () => (0, vue_exports.createVNode)("div", {
      "ref": daysRef,
      "role": "grid",
      "class": bem36("days")
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/calendar/CalendarHeader.mjs
var [name40] = createNamespace("calendar-header");
var stdin_default42 = (0, vue_exports.defineComponent)({
  name: name40,
  props: {
    date: Date,
    title: String,
  ...
  setup(props, {
    ...
    const renderWeekDays = () => {
      ...
      }, [renderWeekDays2.map((text) => (0, vue_exports.createVNode)("span", {
        "class": bem36("weekday")
      }, [text]))]);
    };
    return () => (0, vue_exports.createVNode)("div", {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/calendar/Calendar.mjs
var calendarProps = {
  show: Boolean,
...
var stdin_default43 = (0, vue_exports.defineComponent)({
  name: name37,
  props: calendarProps,
  ...
  setup(props, {
    ...
    const subtitle = (0, vue_exports.ref)({
      text: "",
      date: void 0
    });
    const currentDate = (0, vue_exports.ref)(getInitialDate());
    const [monthRefs, setMonthRefs] = useRefs();
    const dayOffset = (0, vue_exports.computed)(() => props.firstDayOfWeek ? +props.firstDayOfWeek % 7 : 0);
    const months = (0, vue_exports.computed)(() => {
      const months2 = [];
    ...
    const buttonDisabled = (0, vue_exports.computed)(() => {
    ...
    const disabledDays = (0, vue_exports.computed)(() => monthRefs.value.reduce((arr, ref210) => {
      var _a, _b;
    ...
    const renderMonth = (date, index) => {
      ...
      return (0, vue_exports.createVNode)(stdin_default41, (0, vue_exports.mergeProps)({
    ...
    const renderFooter = () => (0, vue_exports.createVNode)("div", {
      "class": [bem36("footer"), {
        "van-safe-area-bottom": props.safeAreaInsetBottom
      }]
    }, [renderFooterButton()]);
    const renderCalendar = () => (0, vue_exports.createVNode)("div", {
      "class": bem36()
    }, [(0, vue_exports.createVNode)(stdin_default42, {
    ...
    }, pick(slots, ["title", "subtitle"])), (0, vue_exports.createVNode)("div", {
      "ref": bodyRef,
      "class": bem36("body"),
      "onScroll": onScroll
    }, [months.value.map(renderMonth)]), renderFooter()]);
    (0, vue_exports.watch)(() => props.show, init);
    (0, vue_exports.watch)(() => [props.type, props.minDate, props.maxDate], () => reset(getInitialDate(currentDate.value)));
    (0, vue_exports.watch)(() => props.defaultDate, (value = null) => {
    ...
    return () => {
      if (props.poppable) {
        return (0, vue_exports.createVNode)(Popup, {
          "show": props.show,
          "class": bem36("popup"),
          "round": props.round,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/calendar/index.mjs
var Calendar = withInstall(stdin_default43);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/image/Image.mjs
...
var stdin_default44 = (0, vue_exports.defineComponent)({
  name: name41,
  props: imageProps,
  emits: ["load", "error"],
  setup(props, {
    ...
    const imageRef = (0, vue_exports.ref)();
    const {
      $Lazyload
    } = (0, vue_exports.getCurrentInstance)().proxy;
    const style = (0, vue_exports.computed)(() => {
      const style2 = {
    ...
    const renderImage = () => {
      ...
      if (props.lazyLoad) {
        return (0, vue_exports.withDirectives)((0, vue_exports.createVNode)("img", (0, vue_exports.mergeProps)({
          "ref": imageRef
        }, attrs), null), [[(0, vue_exports.resolveDirective)("lazy"), props.src]]);
      }
      return (0, vue_exports.createVNode)("img", (0, vue_exports.mergeProps)({
        "ref": imageRef,
        "src": props.src,
        "onLoad": onLoad,
        "onError": onError
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/image/index.mjs
var Image2 = withInstall(stdin_default44);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/card/Card.mjs
...
var stdin_default45 = (0, vue_exports.defineComponent)({
  name: name42,
  props: cardProps,
  emits: ["clickThumb"],
  setup(props, {
    ...
    const renderThumbTag = () => {
      if (slots.tag || props.tag) {
        return (0, vue_exports.createVNode)("div", {
          "class": bem38("tag")
        }, [slots.tag ? slots.tag() : (0, vue_exports.createVNode)(Tag, {
          "mark": true,
          "type": "primary"
        }, {
          default: () => [props.tag]
    ...
    const renderThumbImage = () => {
      ...
      return (0, vue_exports.createVNode)(Image2, {
        "src": props.thumb,
        "fit": "cover",
        "width": "100%",
        "height": "100%",
    ...
    const renderThumb = () => {
      if (slots.thumb || props.thumb) {
        return (0, vue_exports.createVNode)("a", {
    ...
    const renderPriceText = () => {
      ...
      return (0, vue_exports.createVNode)("div", null, [(0, vue_exports.createVNode)("span", {
        "class": bem38("price-currency")
      }, [props.currency]), (0, vue_exports.createVNode)("span", {
        "class": bem38("price-integer")
      }, [priceArr[0]]), (0, vue_exports.createTextVNode)("."), (0, vue_exports.createVNode)("span", {
    ...
    return () => {
      ...
      const Price = showPrice && (0, vue_exports.createVNode)("div", {
        "class": bem38("price")
      }, [slots.price ? slots.price() : renderPriceText()]);
      const OriginPrice = showOriginPrice && (0, vue_exports.createVNode)("div", {
        "class": bem38("origin-price")
      }, [slots["origin-price"] ? slots["origin-price"]() : `${props.currency} ${props.originPrice}`]);
      const Num = showNum && (0, vue_exports.createVNode)("div", {
        "class": bem38("num")
      }, [slots.num ? slots.num() : `x${props.num}`]);
      const Footer = slots.footer && (0, vue_exports.createVNode)("div", {
        "class": bem38("footer")
      }, [slots.footer()]);
      const Bottom = showBottom && (0, vue_exports.createVNode)("div", {
        "class": bem38("bottom")
      ...
      return (0, vue_exports.createVNode)("div", {
        ...
        "class": bem38("header")
      }, [renderThumb(), (0, vue_exports.createVNode)("div", {
        "class": bem38("content", {
          centered: props.centered
        })
      }, [(0, vue_exports.createVNode)("div", null, [renderTitle(), renderDesc(), (_c = slots.tags) == null ? void 0 : _c.call(slots)]), Bottom])]), Footer]);
    };
  }
});

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/card/index.mjs
var Card = withInstall(stdin_default45);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/cascader/Cascader.mjs
...
var stdin_default46 = (0, vue_exports.defineComponent)({
  name: name43,
  props: cascaderProps,
  ...
  setup(props, {
    ...
    const renderHeader = () => props.showHeader ? (0, vue_exports.createVNode)("div", {
      "class": bem39("header")
    }, [(0, vue_exports.createVNode)("h2", {
      "class": bem39("title")
    }, [slots.title ? slots.title() : props.title]), props.closeable ? (0, vue_exports.createVNode)(Icon, {
      "name": props.closeIcon,
    ...
    const renderOption = (option, selectedOption, tabIndex) => {
      ...
      const Text2 = slots.option ? slots.option({
        option,
        selected
      }) : (0, vue_exports.createVNode)("span", null, [option[textKey]]);
      return (0, vue_exports.createVNode)("li", {
        "role": "menuitemradio",
        "class": [bem39("option", {
          selected,
          disabled
      ...
      }, [Text2, selected ? (0, vue_exports.createVNode)(Icon, {
        "name": "success",
        "class": bem39("selected-icon")
      }, null) : null]);
    };
    const renderOptions = (options, selectedOption, tabIndex) => (0, vue_exports.createVNode)("ul", {
      "role": "menu",
      "class": bem39("options")
    ...
    const renderTab = (tab, tabIndex) => {
      ...
      return (0, vue_exports.createVNode)(Tab, {
        "title": title,
    ...
    const renderTabs = () => (0, vue_exports.createVNode)(Tabs, {
      "active": activeTab.value,
      "onUpdate:active": ($event) => activeTab.value = $event,
      "shrink": true,
      "animated": true,
    ...
    updateTabs();
    (0, vue_exports.watch)(() => props.options, updateTabs, {
      deep: true
    });
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/cascader/index.mjs
var Cascader = withInstall(stdin_default46);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/cell-group/CellGroup.mjs
...
var stdin_default47 = (0, vue_exports.defineComponent)({
  name: name44,
  inheritAttrs: false,
  ...
  setup(props, {
    ...
    const renderTitle = () => (0, vue_exports.createVNode)("div", {
      "class": bem40("title", {
        inset: props.inset
      })
    }, [slots.title ? slots.title() : props.title]);
    return () => {
      if (props.title || slots.title) {
        return (0, vue_exports.createVNode)(vue_exports.Fragment, null, [renderTitle(), renderGroup()]);
      }
      return renderGroup();
    };
  }
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/cell-group/index.mjs
var CellGroup = withInstall(stdin_default47);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/checkbox-group/CheckboxGroup.mjs
...
var stdin_default48 = (0, vue_exports.defineComponent)({
  name: name45,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/checkbox/Checkbox.mjs
var [name46, bem42] = createNamespace("checkbox");
var checkboxProps = extend({}, checkerProps, {
  bindGroup: truthProp
});
var stdin_default49 = (0, vue_exports.defineComponent)({
  name: name46,
  props: checkboxProps,
  emits: ["change", "update:modelValue"],
  setup(props, {
    ...
    const checked = (0, vue_exports.computed)(() => {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/checkbox/index.mjs
var Checkbox = withInstall(stdin_default49);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/checkbox-group/index.mjs
var CheckboxGroup = withInstall(stdin_default48);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/circle/Circle.mjs
...
var stdin_default50 = (0, vue_exports.defineComponent)({
  name: name47,
  props: circleProps,
  ...
  setup(props, {
    ...
    const viewBoxSize = (0, vue_exports.computed)(() => +props.strokeWidth + 1e3);
    const path = (0, vue_exports.computed)(() => getPath(props.clockwise, viewBoxSize.value));
    const svgStyle = (0, vue_exports.computed)(() => {
    ...
    (0, vue_exports.watch)(() => props.rate, (rate) => {
      let rafId;
    ...
    const renderHover = () => {
      ...
      return (0, vue_exports.createVNode)("path", {
        "d": path.value,
        "style": style,
        "class": bem43("hover"),
        "stroke": color
    ...
    const renderGradient = () => {
      ...
      const Stops = Object.keys(color).sort((a, b) => parseFloat(a) - parseFloat(b)).map((key, index) => (0, vue_exports.createVNode)("stop", {
        "key": index,
        "offset": key,
        "stop-color": color[key]
      }, null));
      return (0, vue_exports.createVNode)("defs", null, [(0, vue_exports.createVNode)("linearGradient", {
        "id": id,
        "x1": "100%",
        "y1": "0%",
        "x2": "0%",
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/circle/index.mjs
var Circle = withInstall(stdin_default50);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/row/Row.mjs
...
var stdin_default51 = (0, vue_exports.defineComponent)({
  name: name48,
  props: rowProps,
  setup(props, {
    slots
    ...
    const spaces = (0, vue_exports.computed)(() => {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/col/Col.mjs
...
var stdin_default52 = (0, vue_exports.defineComponent)({
  name: name49,
  props: colProps,
  setup(props, {
    slots
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/col/index.mjs
var Col = withInstall(stdin_default52);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/collapse/Collapse.mjs
...
var stdin_default53 = (0, vue_exports.defineComponent)({
  name: name50,
  props: collapseProps,
  emits: ["change", "update:modelValue"],
  setup(props, {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/collapse/index.mjs
var Collapse = withInstall(stdin_default53);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/collapse-item/CollapseItem.mjs
...
var stdin_default54 = (0, vue_exports.defineComponent)({
  name: name51,
  props: collapseItemProps,
  setup(props, {
    slots
  }) {
    const wrapperRef = (0, vue_exports.ref)();
    const contentRef = (0, vue_exports.ref)();
    const {
      parent,
      index
    ...
    const name210 = (0, vue_exports.computed)(() => {
      var _a;
      return (_a = props.name) != null ? _a : index.value;
    });
    const expanded = (0, vue_exports.computed)(() => parent.isExpanded(name210.value));
    const show = (0, vue_exports.ref)(expanded.value);
    ...
    (0, vue_exports.watch)(expanded, (value, oldValue) => {
      if (oldValue === null) {
        return;
      }
      if (value) {
      ...
      const tick = value ? vue_exports.nextTick : raf;
      tick(() => {
    ...
    const renderTitle = () => {
      ...
      return (0, vue_exports.createVNode)(Cell, (0, vue_exports.mergeProps)({
        "role": "button",
        "class": bem47("title", {
          disabled,
    ...
    const renderContent = lazyRender(() => {
      ...
      return (0, vue_exports.withDirectives)((0, vue_exports.createVNode)("div", {
        ...
        "ref": contentRef,
        "class": bem47("content")
      }, [(_a = slots.default) == null ? void 0 : _a.call(slots)])]), [[vue_exports.vShow, show.value]]);
    });
    useExpose({
      toggle,
      expanded,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/collapse-item/index.mjs
var CollapseItem = withInstall(stdin_default54);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/config-provider/index.mjs
var ConfigProvider = withInstall(stdin_default5);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/contact-card/ContactCard.mjs
...
var stdin_default55 = (0, vue_exports.defineComponent)({
  name: name52,
  ...
  setup(props, {
    ...
    const renderContent = () => {
      ...
      return [(0, vue_exports.createVNode)("div", null, [`${t7("name")}\uFF1A${props.name}`]), (0, vue_exports.createVNode)("div", null, [`${t7("tel")}\uFF1A${props.tel}`])];
    };
    return () => (0, vue_exports.createVNode)(Cell, {
      "center": true,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/contact-card/index.mjs
var ContactCard = withInstall(stdin_default55);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/contact-edit/ContactEdit.mjs
...
var stdin_default56 = (0, vue_exports.defineComponent)({
  name: name53,
  ...
  setup(props, {
    ...
    const contact = (0, vue_exports.reactive)(extend({}, DEFAULT_CONTACT, props.contactInfo));
    const onSave = () => {
      if (!props.isSaving) {
        emit("save", contact);
      }
    ...
    const renderButtons = () => (0, vue_exports.createVNode)("div", {
      "class": bem49("buttons")
    }, [(0, vue_exports.createVNode)(Button, {
      "block": true,
      "round": true,
      ...
      "loading": props.isSaving,
      "nativeType": "submit"
    }, null), props.isEdit && (0, vue_exports.createVNode)(Button, {
      "block": true,
      "round": true,
      "text": t8("delete"),
      "class": bem49("button"),
    ...
    const renderSwitch = () => (0, vue_exports.createVNode)(Switch, {
    ...
    (0, vue_exports.watch)(() => props.contactInfo, (value) => extend(contact, DEFAULT_CONTACT, value));
    return () => (0, vue_exports.createVNode)(Form, {
      "class": bem49(),
      "onSubmit": onSave
    }, {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/contact-edit/index.mjs
var ContactEdit = withInstall(stdin_default56);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/contact-list/ContactList.mjs
...
var stdin_default57 = (0, vue_exports.defineComponent)({
  name: name54,
  ...
  setup(props, {
    ...
    const renderItem = (item, index) => {
      ...
      const renderRightIcon = () => (0, vue_exports.createVNode)(Radio, {
        "class": bem50("radio"),
        "name": item.id,
        "iconSize": 16
      }, null);
      const renderEditIcon = () => (0, vue_exports.createVNode)(Icon, {
        "name": "edit",
        "class": bem50("edit"),
        "onClick": (event) => {
          event.stopPropagation();
      ...
      const renderContent = () => {
        ...
        if (item.isDefault && props.defaultTagText) {
          nodes.push((0, vue_exports.createVNode)(Tag, {
            "type": "primary",
            "round": true,
    ...
    return () => (0, vue_exports.createVNode)("div", {
      "class": bem50()
    }, [(0, vue_exports.createVNode)(RadioGroup, {
      "modelValue": props.modelValue,
      "class": bem50("group")
    }, {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/contact-list/index.mjs
var ContactList = withInstall(stdin_default57);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/count-down/utils.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/count-down/CountDown.mjs
...
var stdin_default58 = (0, vue_exports.defineComponent)({
  name: name55,
  ...
  setup(props, {
    ...
    const timeText = (0, vue_exports.computed)(() => parseFormat(props.format, current2.value));
    const resetTime = () => {
      reset(+props.time);
      if (props.autoStart) {
        start2();
    ...
    (0, vue_exports.watch)(() => props.time, resetTime, {
      immediate: true
    });
    useExpose({
      start: start2,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/count-down/index.mjs
var CountDown = withInstall(stdin_default58);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/coupon/utils.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/coupon/Coupon.mjs
var [name56, bem52, t10] = createNamespace("coupon");
var stdin_default59 = (0, vue_exports.defineComponent)({
  name: name56,
  props: {
    chosen: Boolean,
  ...
  setup(props) {
    const validPeriod = (0, vue_exports.computed)(() => {
      const {
        startAt,
        endAt
      } = props.coupon;
    ...
    const faceAmount = (0, vue_exports.computed)(() => {
      const {
        coupon,
        currency
      } = props;
      if (coupon.valueDesc) {
        return [coupon.valueDesc, (0, vue_exports.createVNode)("span", null, [coupon.unitDesc || ""])];
      }
      if (coupon.denominations) {
        const denominations = formatAmount(coupon.denominations);
        return [(0, vue_exports.createVNode)("span", null, [currency]), ` ${denominations}`];
      }
      if (coupon.discount) {
    ...
    const conditionMessage = (0, vue_exports.computed)(() => {
    ...
    return () => {
      ...
      return (0, vue_exports.createVNode)("div", {
        ...
        "class": bem52("amount")
      }, [faceAmount.value]), (0, vue_exports.createVNode)("p", {
        "class": bem52("condition")
      }, [coupon.condition || conditionMessage.value])]), (0, vue_exports.createVNode)("div", {
        "class": bem52("body")
      }, [(0, vue_exports.createVNode)("p", {
        "class": bem52("name")
      }, [coupon.name]), (0, vue_exports.createVNode)("p", {
        "class": bem52("valid")
      }, [validPeriod.value]), !disabled && (0, vue_exports.createVNode)(Checkbox, {
        "class": bem52("corner"),
        "modelValue": chosen
      }, null)])]), description && (0, vue_exports.createVNode)("p", {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/coupon/index.mjs
var Coupon = withInstall(stdin_default59);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/coupon-cell/CouponCell.mjs
...
var stdin_default60 = (0, vue_exports.defineComponent)({
  name: name57,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/coupon-cell/index.mjs
var CouponCell = withInstall(stdin_default60);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/empty/Empty.mjs
...
var stdin_default61 = (0, vue_exports.defineComponent)({
  name: name58,
  props: emptyProps,
  setup(props, {
    slots
    ...
    const renderDescription = () => {
      ...
      if (description) {
        return (0, vue_exports.createVNode)("p", {
    ...
    const renderStop = (color, offset2, opacity) => (0, vue_exports.createVNode)("stop", {
      "stop-color": color,
      "offset": `${offset2}%`,
      "stop-opacity": opacity
    }, null);
    const renderStops = (fromColor, toColor) => [renderStop(fromColor, 0), renderStop(toColor, 100)];
    const renderShadow = (id) => [(0, vue_exports.createVNode)("defs", null, [(0, vue_exports.createVNode)("radialGradient", {
      "id": getId(id),
      "cx": "50%",
      "cy": "54%",
      "fx": "50%",
    ...
    }, [renderStop("#EBEDF0", 0), renderStop("#F2F3F5", 100, 0.3)])]), (0, vue_exports.createVNode)("ellipse", {
      "fill": getUrlById(id),
      "opacity": ".8",
      "cx": "80",
      "cy": "140",
    ...
    const renderBuilding = () => [(0, vue_exports.createVNode)("defs", null, [(0, vue_exports.createVNode)("linearGradient", {
      "id": getId("a"),
      "x1": "64%",
      "y1": "100%",
      "x2": "64%"
    }, [renderStop("#FFF", 0, 0.5), renderStop("#F2F3F5", 100)])]), (0, vue_exports.createVNode)("g", {
      "opacity": ".8"
    }, [(0, vue_exports.createVNode)("path", {
      "d": "M36 131V53H16v20H2v58h34z",
      "fill": getUrlById("a")
    }, null), (0, vue_exports.createVNode)("path", {
      "d": "M123 15h22v14h9v77h-31V15z",
      "fill": getUrlById("a")
    }, null)])];
    const renderCloud = () => [(0, vue_exports.createVNode)("defs", null, [(0, vue_exports.createVNode)("linearGradient", {
      "id": getId("b"),
      "x1": "64%",
      "y1": "97%",
      "x2": "64%",
      "y2": "0%"
    }, [renderStop("#F2F3F5", 0, 0.3), renderStop("#F2F3F5", 100)])]), (0, vue_exports.createVNode)("g", {
      "opacity": ".8"
    }, [(0, vue_exports.createVNode)("path", {
    ...
    const renderNetwork = () => (0, vue_exports.createVNode)("svg", {
      "viewBox": "0 0 160 160"
    }, [(0, vue_exports.createVNode)("defs", null, [(0, vue_exports.createVNode)("linearGradient", {
      "id": getId(1),
      "x1": "64%",
      "y1": "100%",
      "x2": "64%"
    }, [renderStop("#FFF", 0, 0.5), renderStop("#F2F3F5", 100)]), (0, vue_exports.createVNode)("linearGradient", {
      "id": getId(2),
      "x1": "50%",
      "x2": "50%",
      "y2": "84%"
    }, [renderStop("#EBEDF0", 0), renderStop("#DCDEE0", 100, 0)]), (0, vue_exports.createVNode)("linearGradient", {
      "id": getId(3),
      "x1": "100%",
      "x2": "100%",
      "y2": "100%"
    }, [renderStops("#EAEDF0", "#DCDEE0")]), (0, vue_exports.createVNode)("radialGradient", {
      "id": getId(4),
      "cx": "50%",
      "cy": "0%",
      "fx": "50%",
    ...
    }, [renderStop("#EBEDF0", 0), renderStop("#FFF", 100, 0)])]), (0, vue_exports.createVNode)("g", {
      "fill": "none"
    }, [renderBuilding(), (0, vue_exports.createVNode)("path", {
      "fill": getUrlById(4),
      "d": "M0 139h160v21H0z"
    }, null), (0, vue_exports.createVNode)("path", {
      "d": "M80 54a7 7 0 0 1 3 13v27l-2 2h-2a2 2 0 0 1-2-2V67a7 7 0 0 1 3-13z",
      "fill": getUrlById(2)
    }, null), (0, vue_exports.createVNode)("g", {
      "opacity": ".6",
    ...
    }, [(0, vue_exports.createVNode)("rect", {
      "fill": "#EBEDF0",
      "width": "98",
      "height": "34",
      "rx": "2"
    }, null), (0, vue_exports.createVNode)("rect", {
      "fill": "#FFF",
      "x": "9",
      "y": "8",
      "width": "80",
    ...
    const renderMaterial = () => (0, vue_exports.createVNode)("svg", {
      "viewBox": "0 0 160 160"
    }, [(0, vue_exports.createVNode)("defs", null, [(0, vue_exports.createVNode)("linearGradient", {
      "x1": "50%",
      "x2": "50%",
      "y2": "100%",
      "id": getId(5)
    }, [renderStops("#F2F3F5", "#DCDEE0")]), (0, vue_exports.createVNode)("linearGradient", {
      "x1": "95%",
      "y1": "48%",
      "x2": "5.5%",
      "y2": "51%",
      "id": getId(6)
    }, [renderStops("#EAEDF1", "#DCDEE0")]), (0, vue_exports.createVNode)("linearGradient", {
      "y1": "45%",
      "x2": "100%",
      "y2": "54%",
      "id": getId(7)
    }, [renderStops("#EAEDF1", "#DCDEE0")])]), renderBuilding(), renderCloud(), (0, vue_exports.createVNode)("g", {
      "transform": "translate(36 50)",
      "fill": "none"
    }, [(0, vue_exports.createVNode)("g", {
    ...
    const renderError = () => (0, vue_exports.createVNode)("svg", {
      "viewBox": "0 0 160 160"
    }, [(0, vue_exports.createVNode)("defs", null, [(0, vue_exports.createVNode)("linearGradient", {
      "x1": "50%",
      "x2": "50%",
      "y2": "100%",
      "id": getId(8)
    }, [renderStops("#EAEDF1", "#DCDEE0")])]), renderBuilding(), renderCloud(), renderShadow("c"), (0, vue_exports.createVNode)("path", {
      "d": "m59 60 21 21 21-21h3l9 9v3L92 93l21 21v3l-9 9h-3l-21-21-21 21h-3l-9-9v-3l21-21-21-21v-3l9-9h3Z",
      "fill": getUrlById(8)
    }, null)]);
    const renderSearch = () => (0, vue_exports.createVNode)("svg", {
      "viewBox": "0 0 160 160"
    }, [(0, vue_exports.createVNode)("defs", null, [(0, vue_exports.createVNode)("linearGradient", {
      "x1": "50%",
      "y1": "100%",
      "x2": "50%",
      "id": getId(9)
    }, [renderStops("#EEE", "#D8D8D8")]), (0, vue_exports.createVNode)("linearGradient", {
      "x1": "100%",
      "y1": "50%",
      "y2": "50%",
      "id": getId(10)
      ...
      "y2": "100%",
      "id": getId(12)
    }, [renderStops("#FFF", "#F7F8FA")])]), renderBuilding(), renderCloud(), renderShadow("d"), (0, vue_exports.createVNode)("g", {
      ...
      "height": "28",
      "rx": "1"
    }, null), (0, vue_exports.createVNode)("circle", {
    ...
    const renderImage = () => {
      ...
      return ((_a = PRESET_IMAGES[props.image]) == null ? void 0 : _a.call(PRESET_IMAGES)) || (0, vue_exports.createVNode)("img", {
        "src": props.image
      }, null);
    };
    return () => (0, vue_exports.createVNode)("div", {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/empty/index.mjs
var Empty = withInstall(stdin_default61);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/coupon-list/CouponList.mjs
...
var stdin_default62 = (0, vue_exports.defineComponent)({
  name: name59,
  ...
  setup(props, {
    ...
    const activeTab = (0, vue_exports.ref)(0);
    const listHeight = (0, vue_exports.ref)(0);
    const currentCode = (0, vue_exports.ref)(props.code);
    const buttonDisabled = (0, vue_exports.computed)(() => !props.exchangeButtonLoading && (props.exchangeButtonDisabled || !currentCode.value || currentCode.value.length < props.exchangeMinLength));
    ...
    const renderEmpty = () => (0, vue_exports.createVNode)(Empty, {
      "image": props.emptyImage
    }, {
      default: () => [(0, vue_exports.createVNode)("p", {
    ...
    const renderCouponTab = () => {
      ...
      return (0, vue_exports.createVNode)(Tab, {
        ...
        default: () => {
          ...
          }, [coupons.map((coupon, index) => (0, vue_exports.createVNode)(Coupon, {
            "key": coupon.id,
    ...
    const renderDisabledTab = () => {
      ...
      return (0, vue_exports.createVNode)(Tab, {
        ...
        default: () => {
          ...
          }, [disabledCoupons.map((coupon) => (0, vue_exports.createVNode)(Coupon, {
            "disabled": true,
            "key": coupon.id,
            "coupon": coupon,
            "currency": props.currency
    ...
    (0, vue_exports.watch)(() => props.code, (value) => {
      currentCode.value = value;
    });
    (0, vue_exports.watch)(windowHeight, updateListHeight);
    (0, vue_exports.watch)(currentCode, (value) => emit("update:code", value));
    (0, vue_exports.watch)(() => props.displayedCouponIndex, scrollToCoupon);
    (0, vue_exports.onMounted)(() => {
      updateListHeight();
    ...
    return () => (0, vue_exports.createVNode)("div", {
      "ref": root,
      "class": bem55()
    }, [renderExchangeBar(), (0, vue_exports.createVNode)(Tabs, {
      "active": activeTab.value,
      "onUpdate:active": ($event) => activeTab.value = $event,
      "class": bem55("tab")
    }, {
      ...
      "class": bem55("bottom")
    }, [(0, vue_exports.withDirectives)((0, vue_exports.createVNode)(Button, {
      "round": true,
      "block": true,
      "type": "primary",
      "class": bem55("close"),
    ...
    }, null), [[vue_exports.vShow, props.showCloseButton]])])]);
  }
});

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/coupon-list/index.mjs
var CouponList = withInstall(stdin_default62);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/date-picker/DatePicker.mjs
...
var stdin_default63 = (0, vue_exports.defineComponent)({
  name: name60,
  ...
  setup(props, {
    ...
    const currentValues = (0, vue_exports.ref)(props.modelValue);
    ...
    const columns = (0, vue_exports.computed)(() => props.columnsType.map((type) => {
      switch (type) {
        case "year":
    ...
    (0, vue_exports.watch)(currentValues, (newValues) => {
      if (!isSameValue(newValues, props.modelValue)) {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/date-picker/index.mjs
var DatePicker = withInstall(stdin_default63);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/dialog/Dialog.mjs
...
var stdin_default64 = (0, vue_exports.defineComponent)({
  name: name61,
  props: dialogProps,
  ...
  setup(props, {
    ...
    const root = (0, vue_exports.ref)();
    const loading = (0, vue_exports.reactive)({
      confirm: false,
      cancel: false
    });
    const updateShow = (value) => emit("update:show", value);
    ...
    const onKeydown = (0, vue_exports.withKeys)((event) => {
      var _a, _b;
    ...
    const renderButtons = () => (0, vue_exports.createVNode)("div", {
    ...
    }, [props.showCancelButton && (0, vue_exports.createVNode)(Button, {
      "size": "large",
      ...
      "onClick": onCancel
    }, null), props.showConfirmButton && (0, vue_exports.createVNode)(Button, {
      "size": "large",
    ...
    const renderRoundButtons = () => (0, vue_exports.createVNode)(ActionBar, {
      "class": bem56("footer")
    }, {
      default: () => [props.showCancelButton && (0, vue_exports.createVNode)(ActionBarButton, {
        "type": "warning",
        "text": props.cancelButtonText || t13("cancel"),
        "class": bem56("cancel"),
        "color": props.cancelButtonColor,
        ...
        "disabled": props.cancelButtonDisabled,
        "onClick": onCancel
      }, null), props.showConfirmButton && (0, vue_exports.createVNode)(ActionBarButton, {
        "type": "danger",
        "text": props.confirmButtonText || t13("confirm"),
        "class": bem56("confirm"),
        "color": props.confirmButtonColor,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/dialog/function-call.mjs
var instance;
var DEFAULT_OPTIONS = {
  title: "",
  width: "",
...
function initInstance() {
  const Wrapper = {
    setup() {
      ...
      return () => (0, vue_exports.createVNode)(stdin_default64, (0, vue_exports.mergeProps)(state, {
        "onUpdate:show": toggle
      }), null);
    }
  };
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/dialog/index.mjs
var Dialog = withInstall(stdin_default64);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/divider/Divider.mjs
...
var stdin_default65 = (0, vue_exports.defineComponent)({
  name: name62,
  props: dividerProps,
  setup(props, {
    slots
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/divider/index.mjs
var Divider = withInstall(stdin_default65);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/dropdown-menu/DropdownMenu.mjs
...
var stdin_default66 = (0, vue_exports.defineComponent)({
  name: name63,
  ...
  setup(props, {
    ...
    const root = (0, vue_exports.ref)();
    const barRef = (0, vue_exports.ref)();
    const offset2 = (0, vue_exports.ref)(0);
    const {
      children,
      linkChildren
    } = useChildren(DROPDOWN_KEY);
    const scrollParent = useScrollParent(root);
    const opened = (0, vue_exports.computed)(() => children.some((item) => item.state.showWrapper));
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/dropdown-item/DropdownItem.mjs
...
var stdin_default67 = (0, vue_exports.defineComponent)({
  name: name64,
  inheritAttrs: false,
  ...
  setup(props, {
    ...
    const renderContent = () => {
      ...
      }, attrs), [(0, vue_exports.createVNode)(Popup, {
      ...
      })]), [[vue_exports.vShow, state.showWrapper]]);
    };
    useExpose({
      state,
      toggle,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/dropdown-item/index.mjs
var DropdownItem = withInstall(stdin_default67);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/dropdown-menu/index.mjs
var DropdownMenu = withInstall(stdin_default66);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/grid/Grid.mjs
...
var stdin_default68 = (0, vue_exports.defineComponent)({
  name: name65,
  props: gridProps,
  setup(props, {
    slots
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/grid/index.mjs
var Grid = withInstall(stdin_default68);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/grid-item/GridItem.mjs
...
var stdin_default69 = (0, vue_exports.defineComponent)({
  name: name66,
  props: gridItemProps,
  setup(props, {
    slots
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/grid-item/index.mjs
var GridItem = withInstall(stdin_default69);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/image-preview/ImagePreviewItem.mjs
...
var stdin_default70 = (0, vue_exports.defineComponent)({
  props: {
    src: String,
    show: Boolean,
    active: Number,
  ...
  setup(props, {
    ...
    const touch = useTouch();
    const swipeItem = (0, vue_exports.ref)();
    const vertical = (0, vue_exports.computed)(() => {
      const {
        rootWidth,
        rootHeight
      } = props;
    ...
    const maxMoveX = (0, vue_exports.computed)(() => {
      if (state.imageRatio) {
        const {
          rootWidth,
          rootHeight
    ...
    const maxMoveY = (0, vue_exports.computed)(() => {
      if (state.imageRatio) {
        const {
          rootWidth,
          rootHeight
    ...
    (0, vue_exports.watch)(() => props.active, resetScale);
    (0, vue_exports.watch)(() => props.show, (value) => {
      if (!value) {
        resetScale();
      }
    });
    ...
    return () => {
      const imageSlots = {
        loading: () => (0, vue_exports.createVNode)(Loading, {
          "type": "spinner"
        }, null)
      };
      return (0, vue_exports.createVNode)(SwipeItem, {
        ...
        default: () => [slots.image ? (0, vue_exports.createVNode)("div", {
          "class": bem62("image-wrap")
        }, [slots.image({
          src: props.src
        })]) : (0, vue_exports.createVNode)(Image2, {
          "src": props.src,
          "fit": "contain",
          "class": bem62("image", {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/image-preview/ImagePreview.mjs
...
var stdin_default71 = (0, vue_exports.defineComponent)({
  name: name67,
  ...
  setup(props, {
    ...
    const renderImages = () => (0, vue_exports.createVNode)(Swipe, {
      "ref": swipeRef,
      "lazyRender": true,
      "loop": props.loop,
      "class": bem63("swipe"),
      ...
      default: () => [props.images.map((image, index) => (0, vue_exports.createVNode)(stdin_default70, {
        "src": image,
        "show": props.show,
        "active": state.active,
    ...
    (0, vue_exports.onMounted)(resize);
    (0, vue_exports.watch)([windowWidth, windowHeight], resize);
    (0, vue_exports.watch)(() => props.startPosition, (value) => setActive(+value));
    (0, vue_exports.watch)(() => props.show, (value) => {
      const {
        images,
        startPosition
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/image-preview/function-call.mjs
var instance2;
var defaultConfig = {
  loop: true,
  images: [],
...
function initInstance2() {
  ({
    ...
    setup() {
      ...
      return () => (0, vue_exports.createVNode)(stdin_default71, (0, vue_exports.mergeProps)(state, {
        "onClosed": onClosed,
        "onUpdate:show": toggle
      }), null);
    }
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/image-preview/index.mjs
var ImagePreview = withInstall(stdin_default71);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/index-bar/IndexBar.mjs
...
var stdin_default72 = (0, vue_exports.defineComponent)({
  name: name68,
  props: indexBarProps,
  emits: ["select", "change"],
  setup(props, {
    ...
    const root = (0, vue_exports.ref)();
    const sidebar = (0, vue_exports.ref)();
    const activeAnchor = (0, vue_exports.ref)("");
    const touch = useTouch();
    const scrollParent = useScrollParent(root);
    const {
      children,
    ...
    const sidebarStyle = (0, vue_exports.computed)(() => {
    ...
    const highlightStyle = (0, vue_exports.computed)(() => {
    ...
    const init = () => {
      (0, vue_exports.nextTick)(onScroll);
    };
    useEventListener("scroll", onScroll, {
      target: scrollParent,
      passive: true
    ...
    (0, vue_exports.watch)(() => props.indexList, init);
    (0, vue_exports.watch)(activeAnchor, (value) => {
      if (value) {
        emit("change", value);
      }
    });
    ...
    const renderSidebar = () => (0, vue_exports.createVNode)("div", {
      "ref": sidebar,
      "class": bem64("sidebar"),
    ...
    return () => {
      ...
      return (0, vue_exports.createVNode)("div", {
        "ref": root,
        "class": bem64()
      }, [props.teleport ? (0, vue_exports.createVNode)(vue_exports.Teleport, {
        "to": props.teleport
      }, {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/index-anchor/IndexAnchor.mjs
var [name69, bem65] = createNamespace("index-anchor");
var indexAnchorProps = {
  index: numericProp
};
var stdin_default73 = (0, vue_exports.defineComponent)({
  name: name69,
  ...
  setup(props, {
    ...
    const anchorStyle = (0, vue_exports.computed)(() => {
      const {
        zIndex,
        highlightColor
      } = parent.props;
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/index-anchor/index.mjs
var IndexAnchor = withInstall(stdin_default73);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/index-bar/index.mjs
var IndexBar = withInstall(stdin_default72);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/list/List.mjs
...
var stdin_default74 = (0, vue_exports.defineComponent)({
  name: name70,
  props: listProps,
  ...
  setup(props, {
    ...
    const loading = (0, vue_exports.ref)(props.loading);
    const root = (0, vue_exports.ref)();
    const placeholder = (0, vue_exports.ref)();
    ...
    const renderLoading = () => {
      if (loading.value && !props.finished && !props.disabled) {
        return (0, vue_exports.createVNode)("div", {
          "class": bem66("loading")
        }, [slots.loading ? slots.loading() : (0, vue_exports.createVNode)(Loading, {
    ...
    (0, vue_exports.watch)(() => [props.loading, props.finished, props.error], check);
    if (tabStatus) {
      (0, vue_exports.watch)(tabStatus, (tabActive) => {
        if (tabActive) {
          check();
        }
      });
    ...
    return () => {
      var _a;
      const Content = (_a = slots.default) == null ? void 0 : _a.call(slots);
      const Placeholder = (0, vue_exports.createVNode)("div", {
        "ref": placeholder,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/list/index.mjs
var List = withInstall(stdin_default74);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/nav-bar/NavBar.mjs
...
var stdin_default75 = (0, vue_exports.defineComponent)({
  name: name71,
  props: navBarProps,
  ...
  setup(props, {
    ...
    const navBarRef = (0, vue_exports.ref)();
    ...
    const renderLeft = () => {
      ...
      return [props.leftArrow && (0, vue_exports.createVNode)(Icon, {
        "class": bem67("arrow"),
        "name": "arrow-left"
      }, null), props.leftText && (0, vue_exports.createVNode)("span", {
        "class": bem67("text")
      }, [props.leftText])];
    };
    const renderRight = () => {
    ...
    const renderNavBar = () => {
      ...
      return (0, vue_exports.createVNode)("div", {
        ...
        "class": bem67("content")
      }, [hasLeft && (0, vue_exports.createVNode)("div", {
        "class": [bem67("left"), props.clickable ? HAPTICS_FEEDBACK : ""],
        "onClick": onClickLeft
      }, [renderLeft()]), (0, vue_exports.createVNode)("div", {
        "class": [bem67("title"), "van-ellipsis"]
      }, [slots.title ? slots.title() : title]), hasRight && (0, vue_exports.createVNode)("div", {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/nav-bar/index.mjs
var NavBar = withInstall(stdin_default75);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/notice-bar/NoticeBar.mjs
...
var stdin_default76 = (0, vue_exports.defineComponent)({
  name: name72,
  ...
  setup(props, {
    ...
    (0, vue_exports.watch)(() => [props.text, props.scrollable], reset);
    return () => {
      const {
        color,
        wrapable,
      ...
      }, [renderLeftIcon(), renderMarquee(), renderRightIcon()]), [[vue_exports.vShow, state.show]]);
    };
  }
});

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/notice-bar/index.mjs
var NoticeBar = withInstall(stdin_default76);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/notify/Notify.mjs
...
var stdin_default77 = (0, vue_exports.defineComponent)({
  name: name73,
  props: notifyProps,
  emits: ["update:show"],
  setup(props, {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/notify/function-call.mjs
var timer;
var instance3;
...
function initInstance3() {
  ({
    ...
    setup() {
      ...
      return () => (0, vue_exports.createVNode)(stdin_default77, (0, vue_exports.mergeProps)(state, {
        "onUpdate:show": toggle
      }), null);
    }
  }));
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/notify/index.mjs
var Notify = withInstall(stdin_default77);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/number-keyboard/NumberKeyboardKey.mjs
var [name74, bem70] = createNamespace("key");
var CollapseIcon = (0, vue_exports.createVNode)("svg", {
...
var DeleteIcon = (0, vue_exports.createVNode)("svg", {
...
var stdin_default78 = (0, vue_exports.defineComponent)({
  name: name74,
  props: {
    type: String,
    text: numericProp,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/number-keyboard/NumberKeyboard.mjs
...
var stdin_default79 = (0, vue_exports.defineComponent)({
  name: name75,
  inheritAttrs: false,
  ...
  setup(props, {
    ...
    const keys = (0, vue_exports.computed)(() => props.theme === "custom" ? genCustomKeys() : genDefaultKeys());
    const onBlur = () => {
      if (props.show) {
        emit("blur");
      }
    ...
    const renderTitle = () => {
      ...
      return (0, vue_exports.createVNode)("div", {
        "class": bem71("header")
      }, [leftSlot && (0, vue_exports.createVNode)("span", {
        "class": bem71("title-left")
      }, [leftSlot()]), title && (0, vue_exports.createVNode)("h2", {
        "class": bem71("title")
      }, [title]), showClose && (0, vue_exports.createVNode)("button", {
        "type": "button",
    ...
    const renderKeys = () => keys.value.map((key) => {
      ...
      return (0, vue_exports.createVNode)(stdin_default78, {
        "key": key.text,
        "text": key.text,
        "type": key.type,
        "wider": key.wider,
    ...
    const renderSidebar = () => {
      if (props.theme === "custom") {
        return (0, vue_exports.createVNode)("div", {
          "class": bem71("sidebar")
        }, [props.showDeleteKey && (0, vue_exports.createVNode)(stdin_default78, {
          "large": true,
          ...
          delete: slots.delete
        }), (0, vue_exports.createVNode)(stdin_default78, {
          "large": true,
    ...
    return () => {
      ...
      const Content = (0, vue_exports.createVNode)(vue_exports.Transition, {
        "name": props.transition ? "van-slide-up" : ""
      }, {
        default: () => [(0, vue_exports.withDirectives)((0, vue_exports.createVNode)("div", (0, vue_exports.mergeProps)({
          "ref": root,
        ...
        }, attrs), [Title, (0, vue_exports.createVNode)("div", {
          "class": bem71("body")
        }, [(0, vue_exports.createVNode)("div", {
          "class": bem71("keys")
        }, [renderKeys()]), renderSidebar()])]), [[vue_exports.vShow, props.show]])]
      });
      if (props.teleport) {
        return (0, vue_exports.createVNode)(vue_exports.Teleport, {
          "to": props.teleport
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/number-keyboard/index.mjs
var NumberKeyboard = withInstall(stdin_default79);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/pagination/Pagination.mjs
...
var stdin_default80 = (0, vue_exports.defineComponent)({
  name: name76,
  ...
  setup(props, {
    ...
    const count = (0, vue_exports.computed)(() => {
      const {
        pageCount,
        totalItems,
        itemsPerPage
    ...
    (0, vue_exports.watchEffect)(() => updateModelValue(props.modelValue));
    const renderDesc = () => (0, vue_exports.createVNode)("li", {
    ...
    const renderPages = () => pages.value.map((page) => (0, vue_exports.createVNode)("li", {
      "class": [bem72("item", {
        active: page.active,
        page: true
      }), BORDER_SURROUND]
    ...
    return () => (0, vue_exports.createVNode)("nav", {
      "role": "navigation",
      "class": bem72()
    }, [(0, vue_exports.createVNode)("ul", {
      "class": bem72("items")
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/pagination/index.mjs
var Pagination = withInstall(stdin_default80);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/password-input/PasswordInput.mjs
...
var stdin_default81 = (0, vue_exports.defineComponent)({
  name: name77,
  ...
  setup(props, {
    ...
    const renderPoints = () => {
      ...
      for (let i = 0; i < length; i++) {
        ...
        Points.push((0, vue_exports.createVNode)("li", {
          "class": [{
          ...
          "style": style
        }, [mask ? (0, vue_exports.createVNode)("i", {
          "style": {
            visibility: char ? "visible" : "hidden"
          }
        }, null) : char, showCursor && (0, vue_exports.createVNode)("div", {
          "class": bem73("cursor")
        }, null)]));
      }
      return Points;
    ...
    return () => {
      ...
      return (0, vue_exports.createVNode)("div", {
        ...
        "onTouchstartPassive": onTouchStart
      }, [renderPoints()]), info && (0, vue_exports.createVNode)("div", {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/password-input/index.mjs
var PasswordInput = withInstall(stdin_default81);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/picker-group/index.mjs
var PickerGroup = withInstall(stdin_default23);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/@vant/popperjs/dist/index.esm.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/composables/use-sync-prop-ref.mjs
var useSyncPropRef = (getProp, setProp) => {
  const propRef = (0, vue_exports.ref)(getProp());
  (0, vue_exports.watch)(getProp, (value) => {
    if (value !== propRef.value) {
      propRef.value = value;
    }
  });
  (0, vue_exports.watch)(propRef, (value) => {
    if (value !== getProp()) {
      setProp(value);
    }
  });
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/popover/Popover.mjs
...
var stdin_default82 = (0, vue_exports.defineComponent)({
  name: name78,
  props: popoverProps,
  ...
  setup(props, {
    ...
    const popupRef = (0, vue_exports.ref)();
    const wrapperRef = (0, vue_exports.ref)();
    const popoverRef = (0, vue_exports.ref)();
    ...
    const renderActionContent = (action, index) => {
      ...
      return [action.icon && (0, vue_exports.createVNode)(Icon, {
        "name": action.icon,
        "classPrefix": props.iconPrefix,
    ...
    (0, vue_exports.watch)(() => [show.value, props.offset, props.placement], updateLocation);
    useClickAway([wrapperRef, popupRef], onClickAway, {
      eventName: "touchstart"
    });
    return () => {
      var _a;
      return (0, vue_exports.createVNode)(vue_exports.Fragment, null, [(0, vue_exports.createVNode)("span", {
        "ref": wrapperRef,
        "class": bem74("wrapper"),
        "onClick": onClickWrapper
      }, [(_a = slots.reference) == null ? void 0 : _a.call(slots)]), (0, vue_exports.createVNode)(Popup, (0, vue_exports.mergeProps)({
        "ref": popoverRef,
        "show": show.value,
        ...
        default: () => [props.showArrow && (0, vue_exports.createVNode)("div", {
          "class": bem74("arrow")
        }, null), (0, vue_exports.createVNode)("div", {
          "role": "menu",
          "class": bem74("content")
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/popover/index.mjs
var Popover = withInstall(stdin_default82);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/progress/Progress.mjs
...
var stdin_default83 = (0, vue_exports.defineComponent)({
  name: name79,
  props: progressProps,
  setup(props) {
    const background = (0, vue_exports.computed)(() => props.inactive ? void 0 : props.color);
    const renderPivot = () => {
      const {
        textColor,
        pivotText,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/progress/index.mjs
var Progress = withInstall(stdin_default83);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/pull-refresh/PullRefresh.mjs
...
var stdin_default84 = (0, vue_exports.defineComponent)({
  name: name80,
  ...
  setup(props, {
    ...
    const renderStatus = () => {
      ...
      if (TEXT_STATUS.includes(status)) {
        nodes.push((0, vue_exports.createVNode)("div", {
          "class": bem76("text")
        }, [getStatusText()]));
      }
      if (status === "loading") {
        nodes.push((0, vue_exports.createVNode)(Loading, {
          "class": bem76("loading")
        }, {
    ...
    const onTouchEnd = () => {
      if (reachTop && touch.deltaY.value && isTouchable()) {
        ...
        if (state.status === "loosing") {
          ...
          (0, vue_exports.nextTick)(() => emit("refresh"));
        } else {
          setStatus(0);
        }
      }
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/pull-refresh/index.mjs
var PullRefresh = withInstall(stdin_default84);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/rate/Rate.mjs
...
var stdin_default85 = (0, vue_exports.defineComponent)({
  name: name81,
  props: rateProps,
  emits: ["change", "update:modelValue"],
  setup(props, {
    ...
    const groupRef = (0, vue_exports.ref)();
    const untouchable = () => props.readonly || props.disabled || !props.touchable;
    const list = (0, vue_exports.computed)(() => Array(+props.count).fill("").map((_, i) => getRateStatus(props.modelValue, i + 1, props.allowHalf, props.readonly)));
    let ranges;
    let groupRefRect;
    ...
    const renderStar = (item, index) => {
      ...
      return (0, vue_exports.createVNode)("div", {
        ...
        "classPrefix": iconPrefix
      }, null), renderHalf && (0, vue_exports.createVNode)(Icon, {
        "size": size,
        "style": {
          width: item.value + "em"
        },
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/rate/index.mjs
var Rate = withInstall(stdin_default85);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/row/index.mjs
var Row = withInstall(stdin_default51);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/search/Search.mjs
...
var stdin_default86 = (0, vue_exports.defineComponent)({
  name: name82,
  props: searchProps,
  ...
  setup(props, {
    ...
    const id = useId();
    const filedRef = (0, vue_exports.ref)();
    const onCancel = () => {
      if (!slots.action) {
        emit("update:modelValue", "");
        emit("cancel");
    ...
    const renderField = () => {
      ...
      return (0, vue_exports.createVNode)(Field, (0, vue_exports.mergeProps)({
        "ref": filedRef,
        "type": "search",
        "class": bem78("field"),
        "border": false,
    ...
    return () => {
      ...
      }, [(_a = slots.left) == null ? void 0 : _a.call(slots), (0, vue_exports.createVNode)("div", {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/search/index.mjs
var Search = withInstall(stdin_default86);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/share-sheet/ShareSheet.mjs
...
var stdin_default87 = (0, vue_exports.defineComponent)({
  name: name83,
  ...
  setup(props, {
    ...
    const renderHeader = () => {
      ...
      if (title || description) {
        return (0, vue_exports.createVNode)("div", {
          "class": bem79("header")
        }, [title && (0, vue_exports.createVNode)("h2", {
          "class": bem79("title")
        }, [title]), description && (0, vue_exports.createVNode)("span", {
    ...
    const renderIcon = (icon) => {
      ...
      return (0, vue_exports.createVNode)("img", {
        "src": icon,
    ...
    const renderOption = (option, index) => {
      ...
      }, [renderIcon(icon), name210 && (0, vue_exports.createVNode)("span", {
        "class": bem79("name")
      }, [name210]), description && (0, vue_exports.createVNode)("span", {
        "class": bem79("option-description")
      }, [description])]);
    };
    const renderOptions = (options, border) => (0, vue_exports.createVNode)("div", {
      "class": bem79("options", {
        border
      })
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/share-sheet/index.mjs
var ShareSheet = withInstall(stdin_default87);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/sidebar/Sidebar.mjs
var [name84, bem80] = createNamespace("sidebar");
var SIDEBAR_KEY = Symbol(name84);
var sidebarProps = {
  modelValue: makeNumericProp(0)
};
var stdin_default88 = (0, vue_exports.defineComponent)({
  name: name84,
  props: sidebarProps,
  emits: ["change", "update:modelValue"],
  setup(props, {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/sidebar/index.mjs
var Sidebar = withInstall(stdin_default88);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/sidebar-item/SidebarItem.mjs
...
var stdin_default89 = (0, vue_exports.defineComponent)({
  name: name85,
  ...
  setup(props, {
    ...
    return () => {
      ...
      return (0, vue_exports.createVNode)("div", {
        ...
        "onClick": onClick
      }, [(0, vue_exports.createVNode)(Badge, (0, vue_exports.mergeProps)({
        "dot": dot,
        "class": bem81("text"),
        "content": badge
      }, props.badgeProps), {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/sidebar-item/index.mjs
var SidebarItem = withInstall(stdin_default89);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/skeleton-title/SkeletonTitle.mjs
var [name86, bem82] = createNamespace("skeleton-title");
var skeletonTitleProps = {
  round: Boolean,
  titleWidth: numericProp
};
var stdin_default90 = (0, vue_exports.defineComponent)({
  name: name86,
  props: skeletonTitleProps,
  setup(props) {
    return () => (0, vue_exports.createVNode)("h3", {
      "class": bem82([{
        round: props.round
      }]),
      "style": {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/skeleton-title/index.mjs
var SkeletonTitle = withInstall(stdin_default90);
var stdin_default91 = SkeletonTitle;

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/skeleton-avatar/SkeletonAvatar.mjs
var [name87, bem83] = createNamespace("skeleton-avatar");
var skeletonAvatarProps = {
  avatarSize: numericProp,
  avatarShape: makeStringProp("round")
};
var stdin_default92 = (0, vue_exports.defineComponent)({
  name: name87,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/skeleton-avatar/index.mjs
var SkeletonAvatar = withInstall(stdin_default92);
var stdin_default93 = SkeletonAvatar;

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/skeleton-paragraph/SkeletonParagraph.mjs
...
var stdin_default94 = (0, vue_exports.defineComponent)({
  name: name88,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/skeleton-paragraph/index.mjs
var SkeletonParagraph = withInstall(stdin_default94);
var stdin_default95 = SkeletonParagraph;

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/skeleton/Skeleton.mjs
...
var stdin_default96 = (0, vue_exports.defineComponent)({
  name: name89,
  inheritAttrs: false,
  props: skeletonProps,
  setup(props, {
    ...
    const renderAvatar = () => {
      if (props.avatar) {
        return (0, vue_exports.createVNode)(stdin_default93, {
    ...
    const renderTitle = () => {
      if (props.title) {
        return (0, vue_exports.createVNode)(stdin_default91, {
          "round": props.round,
    ...
    const renderRows = () => Array(+props.row).fill("").map((_, i) => (0, vue_exports.createVNode)(stdin_default95, {
      "key": i,
      "round": props.round,
    ...
    const renderContents = () => {
      ...
      return (0, vue_exports.createVNode)(vue_exports.Fragment, null, [renderAvatar(), (0, vue_exports.createVNode)("div", {
        "class": bem85("content")
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/skeleton/index.mjs
var Skeleton = withInstall(stdin_default96);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/skeleton-image/SkeletonImage.mjs
var [name90, bem86] = createNamespace("skeleton-image");
var skeletonImageProps = {
  imageSize: numericProp,
  imageShape: makeStringProp("square")
};
var stdin_default97 = (0, vue_exports.defineComponent)({
  name: name90,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/skeleton-image/index.mjs
var SkeletonImage = withInstall(stdin_default97);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/slider/Slider.mjs
...
var stdin_default98 = (0, vue_exports.defineComponent)({
  name: name91,
  props: sliderProps,
  ...
  setup(props, {
    ...
    let startValue;
    const root = (0, vue_exports.ref)();
    const slider = [(0, vue_exports.ref)(), (0, vue_exports.ref)()];
    const dragStatus = (0, vue_exports.ref)();
    const touch = useTouch();
    const scope = (0, vue_exports.computed)(() => Number(props.max) - Number(props.min));
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/slider/index.mjs
var Slider = withInstall(stdin_default98);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/space/Space.mjs
...
function filterEmpty(children = []) {
  ...
  children.forEach((child) => {
    if (Array.isArray(child)) {
      nodes.push(...child);
    } else if (child.type === vue_exports.Fragment) {
  ...
  return nodes.filter((c) => {
    var _a;
    return !(c && (c.type === vue_exports.Comment || c.type === vue_exports.Fragment && ((_a = c.children) == null ? void 0 : _a.length) === 0 || c.type === vue_exports.Text && c.children.trim() === ""));
  });
}
var stdin_default99 = (0, vue_exports.defineComponent)({
  name: name92,
  props: spaceProps,
  setup(props, {
    slots
  }) {
    const mergedAlign = (0, vue_exports.computed)(() => {
      var _a;
    ...
    return () => {
      ...
      }, [children.map((c, i) => (0, vue_exports.createVNode)("div", {
        "key": `item-${i}`,
        "class": `${name92}-item`,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/space/index.mjs
var Space = withInstall(stdin_default99);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/steps/Steps.mjs
...
var stdin_default100 = (0, vue_exports.defineComponent)({
  name: name93,
  props: stepsProps,
  emits: ["clickStep"],
  setup(props, {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/step/Step.mjs
var [name94, bem90] = createNamespace("step");
var stdin_default101 = (0, vue_exports.defineComponent)({
  name: name94,
  setup(props, {
    slots
  }) {
    ...
    const lineStyle = (0, vue_exports.computed)(() => ({
    ...
    return () => {
      ...
      return (0, vue_exports.createVNode)("div", {
        ...
        "onClick": onClickStep
      }, [(_a = slots.default) == null ? void 0 : _a.call(slots)]), (0, vue_exports.createVNode)("div", {
        "class": bem90("circle-container"),
        "onClick": onClickStep
      }, [renderCircle()]), (0, vue_exports.createVNode)("div", {
        "class": bem90("line"),
        "style": lineStyle.value
      }, null)]);
    };
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/step/index.mjs
var Step = withInstall(stdin_default101);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/stepper/Stepper.mjs
...
var stdin_default102 = (0, vue_exports.defineComponent)({
  name: name95,
  props: stepperProps,
  ...
  setup(props, {
    ...
    let actionType;
    const inputRef = (0, vue_exports.ref)();
    const current2 = (0, vue_exports.ref)(getInitialValue());
    const minusDisabled = (0, vue_exports.computed)(() => props.disabled || props.disableMinus || current2.value <= +props.min);
    const plusDisabled = (0, vue_exports.computed)(() => props.disabled || props.disablePlus || current2.value >= +props.max);
    const inputStyle = (0, vue_exports.computed)(() => ({
      width: addUnit(props.inputWidth),
      height: addUnit(props.buttonSize)
    }));
    const buttonStyle = (0, vue_exports.computed)(() => getSizeStyle(props.buttonSize));
    const check = () => {
    ...
    (0, vue_exports.watch)(() => [props.max, props.min, props.integer, props.decimalLength], check);
    (0, vue_exports.watch)(() => props.modelValue, (value) => {
      if (!isEqual(value, current2.value)) {
        current2.value = format3(value);
      }
    });
    (0, vue_exports.watch)(current2, (value) => {
      emit("update:modelValue", value);
      emit("change", value, {
        name: props.name
      });
    ...
    }, [(0, vue_exports.withDirectives)((0, vue_exports.createVNode)("button", (0, vue_exports.mergeProps)({
      "type": "button",
    ...
    }, createListeners("minus")), null), [[vue_exports.vShow, props.showMinus]]), (0, vue_exports.withDirectives)((0, vue_exports.createVNode)("input", {
      "ref": inputRef,
    ...
    }, null), [[vue_exports.vShow, props.showInput]]), (0, vue_exports.withDirectives)((0, vue_exports.createVNode)("button", (0, vue_exports.mergeProps)({
      "type": "button",
      "style": buttonStyle.value,
      "class": [bem91("plus", {
    ...
    }, createListeners("plus")), null), [[vue_exports.vShow, props.showPlus]])]);
  }
});

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/stepper/index.mjs
var Stepper = withInstall(stdin_default102);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/steps/index.mjs
var Steps = withInstall(stdin_default100);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/submit-bar/SubmitBar.mjs
...
var stdin_default103 = (0, vue_exports.defineComponent)({
  name: name96,
  ...
  setup(props, {
    ...
    const renderText = () => {
      ...
      if (typeof price === "number") {
        ...
        }, [(0, vue_exports.createVNode)("span", null, [label || t19("label")]), (0, vue_exports.createVNode)("span", {
          "class": bem92("price")
        }, [currency, (0, vue_exports.createVNode)("span", {
          "class": bem92("price-integer")
        }, [pricePair[0]]), decimal]), suffixLabel && (0, vue_exports.createVNode)("span", {
    ...
    const renderTip = () => {
      ...
      if (slots.tip || tip) {
        return (0, vue_exports.createVNode)("div", {
          "class": bem92("tip")
        }, [tipIcon && (0, vue_exports.createVNode)(Icon, {
          "class": bem92("tip-icon"),
          "name": tipIcon
        }, null), tip && (0, vue_exports.createVNode)("span", {
    ...
    const renderSubmitBar = () => {
      ...
      }, [(_a = slots.top) == null ? void 0 : _a.call(slots), renderTip(), (0, vue_exports.createVNode)("div", {
        "class": bem92("bar")
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/submit-bar/index.mjs
var SubmitBar = withInstall(stdin_default103);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/swipe-cell/SwipeCell.mjs
...
var stdin_default104 = (0, vue_exports.defineComponent)({
  name: name97,
  ...
  setup(props, {
    ...
    let startOffset;
    const root = (0, vue_exports.ref)();
    const leftRef = (0, vue_exports.ref)();
    const rightRef = (0, vue_exports.ref)();
    const state = (0, vue_exports.reactive)({
      offset: 0,
      dragging: false
    });
    ...
    const leftWidth = (0, vue_exports.computed)(() => isDef(props.leftWidth) ? +props.leftWidth : getWidthByRef(leftRef));
    const rightWidth = (0, vue_exports.computed)(() => isDef(props.rightWidth) ? +props.rightWidth : getWidthByRef(rightRef));
    const open = (side) => {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/swipe-cell/index.mjs
var SwipeCell = withInstall(stdin_default104);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tabbar/Tabbar.mjs
...
var stdin_default105 = (0, vue_exports.defineComponent)({
  name: name98,
  props: tabbarProps,
  emits: ["change", "update:modelValue"],
  setup(props, {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tabbar/index.mjs
var Tabbar = withInstall(stdin_default105);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tabbar-item/TabbarItem.mjs
...
var stdin_default106 = (0, vue_exports.defineComponent)({
  name: name99,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tabbar-item/index.mjs
var TabbarItem = withInstall(stdin_default106);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/time-picker/TimePicker.mjs
...
var stdin_default107 = (0, vue_exports.defineComponent)({
  name: name100,
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/time-picker/index.mjs
var TimePicker = withInstall(stdin_default107);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tree-select/TreeSelect.mjs
...
var stdin_default108 = (0, vue_exports.defineComponent)({
  name: name101,
  ...
  setup(props, {
    ...
    const renderSubItem = (item) => {
      ...
      return (0, vue_exports.createVNode)("div", {
        ...
        "onClick": onClick
      }, [item.text, isActiveItem(item.id) && (0, vue_exports.createVNode)(Icon, {
    ...
    const renderSidebar = () => {
      const Items = props.items.map((item) => (0, vue_exports.createVNode)(SidebarItem, {
        "dot": item.dot,
        "title": item.text,
        "badge": item.badge,
      ...
      return (0, vue_exports.createVNode)(Sidebar, {
        "class": bem96("nav"),
    ...
    }, [renderSidebar(), (0, vue_exports.createVNode)("div", {
      "class": bem96("content")
    }, [renderContent()])]);
  }
});

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/tree-select/index.mjs
var TreeSelect = withInstall(stdin_default108);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/uploader/utils.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/uploader/UploaderPreviewItem.mjs
var stdin_default109 = (0, vue_exports.defineComponent)({
  props: {
    name: numericProp,
    item: makeRequiredProp(Object),
    index: Number,
  ...
  setup(props, {
    ...
    const renderMask = () => {
      ...
      if (status === "uploading" || status === "failed") {
        const MaskIcon = status === "failed" ? (0, vue_exports.createVNode)(Icon, {
          "name": "close",
          "class": bem97("mask-icon")
        }, null) : (0, vue_exports.createVNode)(Loading, {
          "class": bem97("loading")
        }, null);
        const showMessage = isDef(message) && message !== "";
        return (0, vue_exports.createVNode)("div", {
          "class": bem97("mask")
        }, [MaskIcon, showMessage && (0, vue_exports.createVNode)("div", {
    ...
    const renderDeleteIcon = () => {
      if (props.deletable && props.item.status !== "uploading") {
        ...
        return (0, vue_exports.createVNode)("div", {
          ...
          "onClick": onDelete
        }, [slot ? slot() : (0, vue_exports.createVNode)(Icon, {
          "name": "cross",
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/uploader/Uploader.mjs
var uploaderProps = {
  name: makeNumericProp(""),
...
var stdin_default110 = (0, vue_exports.defineComponent)({
  name: name102,
  props: uploaderProps,
  ...
  setup(props, {
    ...
    const onAfterRead = (items) => {
      ...
      items = (0, vue_exports.reactive)(items);
    ...
    const renderPreviewItem = (item, index) => {
      ...
      return (0, vue_exports.createVNode)(stdin_default109, (0, vue_exports.mergeProps)({
        "item": item,
        "index": index,
    ...
    const renderUpload = () => {
      ...
      const Input = props.readonly ? null : (0, vue_exports.createVNode)("input", {
        "ref": inputRef,
        "type": "file",
        "class": bem97("input"),
        "accept": props.accept,
      ...
      }, null), props.uploadText && (0, vue_exports.createVNode)("span", {
        "class": bem97("upload-text")
      }, [props.uploadText]), Input]), [[vue_exports.vShow, props.showUpload]]);
    };
    const chooseFile = () => {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/uploader/index.mjs
var Uploader = withInstall(stdin_default110);

// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/lazyload/vue-lazyload/listener.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/lazyload/vue-lazyload/lazy.mjs
  ...
  return class Lazy {
    ...
    add(el, binding, vnode) {
      if (this.listeners.some((item) => item.el === el)) {
        ...
        return (0, vue_exports.nextTick)(this.lazyLoadHandler);
      }
      ...
      (0, vue_exports.nextTick)(() => {
        ...
        (0, vue_exports.nextTick)(() => this.lazyLoadHandler());
      });
    }
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/lazyload/vue-lazyload/lazy-component.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/lazyload/vue-lazyload/lazy-container.mjs
var defaultOptions2 = {
  selector: "img"
};
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/lazyload/vue-lazyload/lazy-image.mjs
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/lazyload/vue-lazyload/index.mjs
var Lazyload = {
  install(app, options = {}) {
...
// C:/Users/admin/Desktop/test-demo/h5-yang/node_modules/vant/es/index.mjs
var version = "4.0.11";
